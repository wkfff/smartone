...
(function ($)
{
    ...
    $.ligerDialog.waitting = function (content)
    {
    	content = content || $.ligerDefaults.Dialog.waittingMessage;
        return $.ligerDialog.open({ cls: 'l-dialog-waittingdialog', type: 'none', content: '<div style="padding:4px">' + content + '</div>', allowClose: false });
    };
