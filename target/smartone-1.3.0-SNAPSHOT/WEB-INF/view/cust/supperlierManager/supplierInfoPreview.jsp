...
<script type="text/javascript">
    ...
    function f_initGrid(colums) {
        $grid = $("#contractInfo").ligerGrid({
            ...
            usePager : true,
            rownumbers : true,
            url : '/cust/supperlierManager/getSupplierTmpList',
            width : '99.6%',
            height : '95%',
            pageSize:200,
            pageSizeOptions:[200],
    ...
    function checkNull(row){
        if(row.SUPPLIER_ID==null||row.SUPPLIER_NAME==null||row.SUPPLIER_PHONE2==null
                ||row.SUPPLIER_CONTACTS==null||row.SUPPLIER_TYPE==null){
            return true;
        }
        return false;
    }
    ...
    function spf_saveCustTmpInfo() {
        ...
        if(checkNotNull()){
            ...
            var options = {
                url : '/cust/supperlierManager/saveSupplierTmpInfo',
                type : 'POST',
