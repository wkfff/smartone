...
//初始化数据 
    ...
    function spf_remove() { 
    	if(spf_checkData()){ 	 		      
             ...
             $.post("/cust/custAppendix/removeAppendix", 
                     [	
                        { name: 'REMOVE_REMARK', value: $("#REMOVE_REMARK").val()},
                        { name: 'CUST_APPEN_ID', value: $("#CUST_APPEN_ID").val()}
                      ]
             , function (result)
             {
    ...
    {     
    	//return true;
        if ($("#CUST_APPEN_ID").val() == null || $("#CUST_APPEN_ID").val() == "") {  
	       	 $.ligerMessageBox.warn('<spring:message code="hrms.warning"/>', '附件编号'+". " + '<spring:message code="input.required"/>') ; 
	       	 return false; 
        }  
...
<body style="padding:2px" >
	<div id="layout1" style="width: 99.6%; margin: 0; padding: 0;">
		<input type="hidden" id="CUST_APPEN_ID" name="CUST_APPEN_ID" value='${appendixDetail.CUST_APPEN_ID}' />
		<table width="99.6%" align="center" cellpadding="0" cellspacing="0"
			...
			<tr>
				<td width="100%" class="l-table-edit-c" colspan="1" nowrap="nowrap">
