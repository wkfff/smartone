...
<script type="text/javascript">
    ...
    function spf_delete()
    {
    	...
    	$.ligerDialog.confirm('<spring:message code="hrms.whetherDelete"/>','<spring:message code="hrms.warning"/>', function (yes)
        {
        	if(yes){
		        ...
		        $.post("/system/appProcessManagement/deleteAppProcessPInfo", 
		                [	
	...
	<style type="text/css"> 
        ...
        #layout1{  width:99.6%;margin:0; padding:0;  } 
    </style>
</head>
     ...
     <table width="99.6%" cellpadding="0" cellspacing="0" class="l-table-edit_01" border="1xp" bordercolor="#A3C0E8">
			            <tr>  
			                ...
			                <td class="l-table-edit-c">
			                	...
			                	<input id="EMPID" name="EMPID" type="hidden" value="${appProcessPInfo.EMPID }"/>
