...
<script type="text/javascript">
	...
	function f_save(){
		if($("#P_VALUE_ID").val() == ""){
			$.ligerMessageBox.warn('<spring:message code="hrms.warning"/>', '请填写值编号') ;
			return ;
		}
		if($("#P_VALUE").val() == ""){
			$.ligerMessageBox.warn('<spring:message code="hrms.warning"/>', '请填写值内容') ;
			return ;
		}
		...
		if(flag){
			...
			var options = {
				url:'/system/basicMaintenance/addPropertyValueInfo',
				type:'POST',
		...
		<div id = 'layout1'>
			<form name="form1" method="post" action="" id="form1">
				<table width="100%" cellpadding="0" cellspacing="0" class="l-table-edit_01" border="1xp" bordercolor="#A3C0E8">
					<tr>
						<td width="40%" class="l-table-edit-t">值编号</td>
						<td width="60%" class="l-table-edit-c">
							<input type="text" name="P_VALUE_ID" id="P_VALUE_ID" value=""/>
						</td>
					</tr>
					<tr>
						<td class="l-table-edit-t">值内容</td>
						<td class="l-table-edit-c"> 
							<input type="text" name="P_VALUE" id="P_VALUE" value=""/>
						</td> 
					</tr>
					<tr>
						<td class="l-table-edit-t">描述</td>
						<td class="l-table-edit-c"> 
