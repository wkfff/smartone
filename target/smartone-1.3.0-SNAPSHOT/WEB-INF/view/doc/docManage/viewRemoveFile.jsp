...
//初始化数据 
    ...
    function spf_remove() { 
    	if(spf_checkData()){ 	 		      
             ...
             $.post("/pro/proManage/removeAppendix", 
                     [	
                        { name: 'REMOVE_REMARK', value: $("#REMOVE_REMARK").val()},
                        { name: 'PRO_APPEN_ID', value: $("#PRO_APPEN_ID").val()}
                      ]
             , function (result)
             {
    ...
    {     
    	//return true;
        if ($("#PRO_APPEN_ID").val() == null || $("#PRO_APPEN_ID").val() == "") {  
	       	 $.ligerMessageBox.warn('<spring:message code="hrms.warning"/>', '文件编号'+". " + '<spring:message code="input.required"/>') ; 
	       	 return false; 
        }  
...
<body style="padding:2px" >
	<div id="layout1" style="width: 99.6%; margin: 0; padding: 0;">
		<input type="hidden" id="PRO_APPEN_ID" name="PRO_APPEN_ID" value='${appendixDetail.PRO_APPEN_ID}' />
