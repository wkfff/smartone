    ...
    function f_initGrid(){
    	$grid = $("#empInfo").ligerGrid({
    		...
    		columns: [
			            ...
			            { display: '<spring:message code="hrms.attendanceTime"/>', name: 'R_TIME', width: 200},
			            { display: '<spring:message code="hrms.applyReason"/>', name: 'APPLYREASON', align: 'left', width: 160,
            ...
            url: '/ess/viewApp/getCardtimeAttInfo',
            parms: [
		...
		<div position="center" id='' title=' '>
			<div position="top">
				<table width="99.6%" cellpadding="0" cellspacing="0"
					...
					<tr>
						<td width="15%" class="l-table-edit-t"><spring:message code="hrms.approvalActive" /></td>
						<td width="25%" class="l-table-edit-c" nowrap="nowrap" ><SipingSoft:selectAppStatus 
								name="qryType" limit="all" onChange="spf_search();" /></td>
						<td width="15%" class="l-table-edit-t"><spring:message code="hrms.applicationDate" /></td>
						<td width="45%" class="l-table-edit-c"><input type="text" name="S_DATE"
