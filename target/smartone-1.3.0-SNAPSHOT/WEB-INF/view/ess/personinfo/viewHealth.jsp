	...
	function f_initGrid() {
		$grid = $("#healthInfo").ligerGrid({
			...
			columns : [ {
				...
				display : '<spring:message code="hrms.examinationDate"/>',
				name : 'PHYSICAL_DATE',
				width : 180
			}, {
				display : '<spring:message code="hrms.physicalExamination"/>',
				name : 'CHECK_YN_NAME',
				width : 180
			}, {
				display : '<spring:message code="hrms.examinationResult"/>',
				name : 'CHECK_RESULT_NAME',
				width : 180
			}, {
