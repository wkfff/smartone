    ...
    <div id="layout1" id='' title=''>
        <div position="center" id='' title=' ' style="border: 0px;">
            ...
            <table width="99.2%" align="center" cellpadding="0" cellspacing="0"
                ...
                <tr height="30px;">
                    <td width="25%" class="l-table-edit-t"><spring:message code="hrms.sex"/></td>
                    <td width="25%" class="l-table-edit-c">${personalInfo.GENDER_NAME }</td>
                    <td width="25%" class="l-table-edit-t"><spring:message code="hrms.nation"/></td>
                    <td width="25%" class="l-table-edit-c">${personalInfo.NATION_NAME }</td>
                </tr>
                <tr height="30px;">
                ...
                <tr height="30px;">
                    <td  class="l-table-edit-t"><spring:message code="hrms.godCardNumber"/></td>
