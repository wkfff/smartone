    ...
    */
    ...
    function spf_selectEmp(){
        $.ligerDialog.open({
            ...
            width: 800,
            height: 400,
            url: '/utility/empInfo/viewAttSearchEmployeeB',
            buttons: [
    ...
    function spf_reviewShift()
    {
        $dialog = $.ligerDialog.open({isDrag: false, title:'<spring:message code="hrms.workingShift.information"/>',
        width: $("#layout1").width()-460, height: $("#layout1").height()-360, url: '/ess/infoApply/searchEmpShift?OT_DATE=' + $("#OT_DATE").val()+'&EMPID='+$("#EMPID").val()
        });
    }
</script>
                ...
                <form name="form1" method="post" action="" id="form1">
                    ...
                    <table width="99.5%" align="center" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            ...
                            <td class="l-table-edit-c" width="35%"><c:if
                                    test="${isSupervisor}">
                        ...
                        <tr>
                            ...
                            <td class="l-table-edit-c">
                                <input type="text" name="LEAVE_FROM_TIME" id="LEAVE_FROM_TIME" onclick="WdatePicker({lang:<spring:message code='dateLanguage'/>,isShowClear:false,readOnly:true,dateFmt:'yyyy-MM-dd HH:mm'})" />
                            </td>
                            <td class="l-table-edit-t">
                                <spring:message code="hrms.endTime" /><font color="red">*</font>
                            </td>
                            <td class="l-table-edit-c">
                                <input type="text" name="LEAVE_TO_TIME" id="LEAVE_TO_TIME" onclick="WdatePicker({lang:<spring:message code='dateLanguage'/>,isShowClear:false,readOnly:true,dateFmt:'yyyy-MM-dd HH:mm'})"/>
                            </td>
                        </tr>
                        <tr>
                            <td class="l-table-edit-t"><spring:message
