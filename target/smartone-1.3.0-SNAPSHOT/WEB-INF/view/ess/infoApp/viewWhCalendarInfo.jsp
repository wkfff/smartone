...
<script type="text/javascript">
	...
	function spf_search() {
		...
		location.href = '/ess/infoApp/viewWhCalendarInfo?year=' + year
	...
	function spf_showDetailData(empID, date) {
		...
		$dialog = $.ligerWindow.show({
			...
			left : 30,
			top : 35,
			url : '/ess/viewApp/viewEmpWhInfo?EMPID=' + empID + '&S_DATE='
					+ sDate + '&E_DATE=' + eDate
		});
	}
</script>
							...
							<tr>
								<td class="l-table-edit-t" colspan="7"><img alt=""
									...
									&nbsp;&nbsp;&nbsp; <SipingSoft:date yearName="year"
										...
										monthSelected="${param.month}" onChange="spf_search();" /> <input
									type="hidden" id="EMPID" name="EMPID" value="${paraMap.EMPID}">
									&nbsp;&nbsp;&nbsp; <img alt=""
