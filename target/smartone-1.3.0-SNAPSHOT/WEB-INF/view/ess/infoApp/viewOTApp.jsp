                ...
                <form name="form1" method="post" action="" id="form1">
                    ...
                    <table width="99.5%" align="center" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            ...
                            <spring:message code="hrms.endTime" /><font color="red">*</font></td>
                            <td class="l-table-edit-c">
                                <table>
                                    <tr>
                        ...
                        <tr>
                            ...
                            <td class="l-table-edit-c">
                                <SipingSoft:selectSyCode parentCode="OTTypeCode" name="OT_TYPE_CODE"
                                    selected="WorkingOtType01" limit="all" />
                            </td>
                            <td class="l-table-edit-t">
                                <spring:message code="hrms.deductionHours" /></td>
                            <td class="l-table-edit-c">
                                <SipingSoft:selectDeduction name="OT_DEDUCTION" /></td>
                        </tr>
                        <tr>
                            <td class="l-table-edit-t">
                                <spring:message code="hrms.workingContent" /><font color="red">*</font>
                            </td>
                            <td class="l-table-edit-c" colspan="3">
                                <textarea rows="" cols="" style="height: 100px; width: 600px" id="OT_CONTENT"
                                    name="OT_CONTENT" validate="{required:true}"></textarea>
                            </td>
                        </tr>
                    </table>
                </form>
