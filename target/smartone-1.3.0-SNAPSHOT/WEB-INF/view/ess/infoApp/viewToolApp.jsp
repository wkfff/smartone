    ...
    function spf_initGrid(){
        ...
        checkbox: false,
            ...
            parms: [{ name: 'EMPID', value: $("#EMPID").attr('value')},
                    { name: '第三方', value: $("#TOOL_TYPE_CODE").attr('value')},
                    ...
                    <table width="99.5%" align="center" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            <td class="l-table-edit-t" width="15%">
                                <spring:message code="hrms.applicant" /></td>
                            <td class="l-table-edit-c" width="35%">${basicInfo.CHINESENAME}
                                <input type="hidden" name="EMPID" id="EMPID"
                                    value="${basicInfo.EMPID}" readonly="readonly"
                                    validate="{required:true}" />
                            <td class="l-table-edit-t" width="15%">
                                <spring:message code='hrms.borrowItems'/><font color="red">*</font></td>
