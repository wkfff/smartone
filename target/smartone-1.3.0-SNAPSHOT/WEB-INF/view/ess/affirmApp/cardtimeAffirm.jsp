...
<script type="text/javascript"> 
    ...
    function f_initGrid()
    {
    	$grid = $("#empInfo").ligerGrid({
            ...
            url: '/ess/affirmApp/getAffirmCardtimeInfo',
            parms: [	
    ...
    {    
    	$dialog = $.ligerDialog.open({isDrag: false, 
    		...
    		width: 700, 
    		height: 320, 
  		    url: '/ess/viewApp/viewApproverInfo?PAGE=A&FLAG='+flag+'&APPLY_TYPE=CardtimeApply&APPLY_NO='+applyNo
       	  });
    }
    ...
    function spf_search()
    {
    	$grid.setOptions({ parms: [	
		                        	...
		                        	{ name: 'CARD_DOOR_TYPE_CODE', value: $("#CARD_DOOR_TYPE_CODE").attr('value')},  
		                        	{ name: 'qryType', value: $("#qryType").attr('value')}
    	                           ],
    	                   newPage: 1
    	                 }); //设置数据参数
			...
			<div position="top">
				<table width="99.6%" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td class="l-table-edit-c"><SipingSoft:selectSyCode
								parentCode="CardDoorType" name="CARD_DOOR_TYPE_CODE"
								onChange="spf_search();" limit="all" /></td>
					</tr>
				</table>
