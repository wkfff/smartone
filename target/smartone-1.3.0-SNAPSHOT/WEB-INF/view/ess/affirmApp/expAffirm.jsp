...
<script type="text/javascript"> 
    ...
    function f_initGrid()
    {
    	$grid = $("#empInfo").ligerGrid({
    		...
    		columns: [   
			            ...
			            { display: '<spring:message code="hrms.expType"/>', name: 'EXP_TYPE_NAME', width: 120,
			            	render: function (item)
		                    {    
			            		if( item.EXP_TYPE_CODE == 'ExpTypeCode001'){
			        	        	return '<a onclick="spf_showExpDetail(1,'+item.APPLY_NO+');" style="cursor: pointer;">'+ item.EXP_TYPE_NAME +'</a>';	
			            		}else{
			        	        	return '<a onclick="spf_showExpDetail(2,'+item.APPLY_NO+');" style="cursor: pointer;">'+ item.EXP_TYPE_NAME +'</a>';	
			            		}		            	     
		                    } 
			            },  
			            { display: '<spring:message code="hrms.applicationDate"/>', name: 'EXP_DATE', width: 110}, 
			            { display: '<spring:message code="hrms.remarks"/>', name: 'EXP_REMARK', align: 'left', width: 140,
            ...
            url: '/ess/affirmApp/getAffirmExpInfo',
            parms: [	
    ...
    {    
    	$dialog = $.ligerDialog.open({isDrag: false, 
    		...
    		width: 700, 
    		height: 320, 
  		    url: '/ess/viewApp/viewApproverInfo?PAGE=A&FLAG='+flag+'&APPLY_TYPE=ExpApply&APPLY_NO='+applyNo
       	  });
    }
    function spf_search()
    {
