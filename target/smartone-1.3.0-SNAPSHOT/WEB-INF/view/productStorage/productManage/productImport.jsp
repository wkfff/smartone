...
<script type="text/javascript">
    function spf_empInfoTemplateDownload() {
        location.href = "/productStorage/productManage/downloadProductsTemp";
    }
    ...
    function spf_empInfoTemplateUpload() {
        $dialogUpload = $.ligerDialog.open({
            ...
            width : 350,
            height : 260,
            url : '/productStorage/productManage/proInfoFileUpload'
        });
    }
    ...
    function spf_showPreview() {
        ...
        $dialogPreview = $.ligerDialog.open({
            ...
            width : 900,
            height : 530,
            url : '/productStorage/productManage/proInfoPreview?1=1'
        });
    }
...
<body style="padding: 2px">
    <table style="height: 100%; background-image: url(/resources/images/background.jpg)" width="99.5%" align="center" cellpadding="0" cellspacing="0" class="l-table-edit" border="0xp"
        ...
        <tr style="height: 10%">
            <td><a style="cursor: pointer; padding-left: 37%;" onclick="spf_empInfoTemplateDownload()"><big><spring:message code="hrms.toDownloadTheTemplate" /></big></a></td>
