...
<script type="text/javascript">
    ...
    function f_initGrid(colums) {
        $grid = $("#contractInfo").ligerGrid({
            ...
            usePager : true,
            rownumbers : true,
            url : '/productStorage/productManage/getProTmpInfoList',
            width : '99.6%',
            height : '95%',
            pageSize:100,
            pageSizeOptions:[100],
    ...
    function checkNull(row){
        if(row.PRODUCT_ID==null||row.PRODUCT_NAME==null||row.UNIT_PRICE==null
                ||row.SPECIFICATION==null||row.UNIT_CODE_ID==null||row.PRODUCT_CATEGORY_ID==null
                ||row.REMARK==null){
            return true;
        }
        return false;
    ...
    function spf_saveProTmpInfo() {
        ...
        if(checkNotNull()){
            ...
            var options = {
                url : '/productStorage/productManage/saveProTmpInfo',
                type : 'POST',
    ...
    <div id="layout1">
        ...
        <table width="99.5%" align="center" cellpadding="0" cellspacing="0" class="l-table-edit" border="0xp" bordercolor="#A3C0E8">
            ...
            <tr>
                <td>
                    <div align="center">
                        <a class="l-button" style="width: 79px; height: 20px;" onclick="spf_saveProTmpInfo()"><spring:message
