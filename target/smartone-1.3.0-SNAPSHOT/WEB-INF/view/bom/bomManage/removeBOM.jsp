...
//初始化数据 
    ...
    {     
    	//return true;
        if ($("#BOM_ID").val() == null || $("#BOM_ID").val() == "") {  
	       	 $.ligerMessageBox.warn('<spring:message code="hrms.warning"/>', 'BOM编号'+". " + '<spring:message code="input.required"/>') ; 
	       	 return false; 
        }  
...
<body style="padding:2px" >
	<div id="layout1" style="width: 99.6%; margin: 0; padding: 0;">
		<input type="hidden" id="BOM_ID" name="BOM_ID" value='${bomDetail.BOM_ID}' />
