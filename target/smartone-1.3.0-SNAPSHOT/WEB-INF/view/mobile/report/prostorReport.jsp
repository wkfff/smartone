    ...
    <div id="main">
        ...
        <div class="content">
            <object  width="100%"  style="background-color: #fff;" height="95%" classid="clsid:D27CDB6E-AE6D-11cf-96B8-444553540000" codebase="http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=7,0,19,0">
                <param name="movie" value="/resources/flash/storage_mobile.swf">
                <param name="quality" value="high">
                <param name="play" value="true">
                <param name=“bgColor” value=“#fff″ />
                <embed src="/resources/flash/storage_mobile.swf"  autostart="true" width="100%"  height="95%"  type="application/x-shockwave-flash" style="background: #fff;">
            </object>
        </div>
    </div>
</body>
