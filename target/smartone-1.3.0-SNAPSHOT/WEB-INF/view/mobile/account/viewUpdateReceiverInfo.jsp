...
<script type="text/javascript">
    ...
    function spf_submit(height) {
        if(checkInput()){
            $.post('/mobile/account/updateReceiver', {
                ...
                if (result == "UPDATE_SUCCESS") {
                    ...
                    location.href="/mobile/account/viewUpdateReceiverInfo?RECEIVER_ID="+$("#RECEIVER_ID").val();
                } else { 
...
<body>
    <div data-role="page" id="mainPage" data-theme="b">
        <div data-role="header" data-theme="b">
           <h1><spring:message code='mobile.modifyReceiver'/></h1>
        </div>
            ...
            <table id="companyInformation">
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="hidden" id="PROVINCE_CODE" value="${receiver.PRO_CODE }"/>
                            <input type="text" id="PROVINCE_NAME" placeholder="<spring:message code='mobile.clickModifyToChoose'/>" 
                             value="${receiver.PRO_NAME }" readOnly/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="hidden" id="CITY_CODE" value="${receiver.CITY_CODE }"/>
                            <input type="text" id="CITY_NAME" placeholder="<spring:message code='mobile.clickModifyToChoose'/>" 
                             value="${receiver.CITY_NAME }" readOnly/>
                    ...
                    <tr>
                        ...
                        <td>
                            <input type="hidden" id="AREA_CODE" value="${receiver.AREA_CODE }"/>
                            <input type="text" id="AREA_NAME" placeholder="<spring:message code='mobile.clickModifyToChoose'/>" 
                            value="${receiver.AREA_NAME }" readOnly/>
                    ...
                    <tr>
                        ...
                        <td colspan="2">
                            <input type="text" id="ADDRESS" value="${receiver.ADDRESS }" onblur="checkAddress()"/>
                    ...
                    <tr>
                       ...
                       <td colspan="2" style="border-top: 1px dashed #cccccc;">
                            <input id="NAME" type="text" value="${receiver.NAME }" onblur="checkName()"/>
                            <span class="tips" id="showNameTips"></span>
                       </td>
                    </tr>
                    <tr>
                       <td><spring:message code='hrms.phoneNumber'/><font color="red">*</font></td>
                       <td colspan="2">
                            <input id="MOBILE" type="text" value="${receiver.MOBILE }" onblur="checkMobile()"/>
                            <span class="tips" id="showMobileTips"></span>
                       </td>
                    </tr>
                    <tr>
                       <td><spring:message code='hrms.fixedTelephone'/></td>
                       <td colspan="2"><input id="TELEPHONE" type="text" value="${receiver.TELEPHONE }"/></td>
                    </tr>
                    <tr>
                       <td><spring:message code='hrms.e-mail'/></td>
                       <td colspan="2"><input id="EMAIL" type="text" value="${receiver.EMAIL }"/></td>
                    </tr>
                    <tr>
                        <td colspan="3">
