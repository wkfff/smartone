...
<script type="text/javascript">
    ...
    function spf_save(){
	    if(spf_checkData()){	    
		      ...
		      var options = {	                        
		          url:'/att/attendanceSettings/addAttMFormulaInfo',
		          type:'POST',	                        
	  ...
	  <div id='layout1' style="position: inherit;margin:0px auto; ">
		     <form name="form1" method="post" action="" id="form1">
		        <table width="99%" cellpadding="1" cellspacing="1" style="height:25px;font-size: 12px;">
					<tr>
						<td width="10%" align="left"><spring:message code="hrms.attItemName"/>:</td>
		           ...
		           <tr>
		           	   ...
		           	   <td width="84%" class="l-table-edit-c">
			       	   		...
			       	   		<input type="hidden" id="ITEM_NO" name="ITEM_NO" value="${paraMap.ITEM_NO }">
			       	   </td>
		           </tr>    
		       </table>
	         </form>
