...
function f_save() {
     ...
     var options = {	                        
       url:'/att/attendanceSettings/addShiftParameterInfo',
       type:'POST',	                        
				           ...
				           <tr> 
				               <td width="15%" class="l-table-edit-t">
				                ...
				                <td class="l-table-edit-c">  
				                    <input type="hidden" name="SHIFT_NO" id="SHIFT_NO" value="${shiftInfo.SHIFT_NO }">
				                    <SipingSoft:select name="AR_ITEM_NO" dataListName="itemInfoList"/>
				                </td> 
			                </tr>  
			                <tr> 
				               <td width="15%" class="l-table-edit-t">
