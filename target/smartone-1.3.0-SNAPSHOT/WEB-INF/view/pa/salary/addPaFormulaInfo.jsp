...
<script type="text/javascript">
	function spf_save() {
		if (spf_checkData()) {
			...
			var options = {
				url: '/pa/salary/addPaFormulaInfo',
				type: 'POST',
	...
	function spf_tool() {
		$dialog = $.ligerWindow.show({
			...
			left: 180,
			top: 60,
			url: '/pa/salary/viewPaFormularTool?PA_MONTH=${paraMap.PA_MONTH }'
		});
	}
</script>
<style type="text/css"> 
...
<body style="padding: 0px">
	<div id='layout1' style="position: inherit; margin: 0px auto;">
		<form name="form1" method="post" action="" id="form1">
			<input type="hidden" id="PA_MONTH" name="PA_MONTH"
				value="${paraMap.PA_MONTH }"> <input type="hidden"
				id="ITEM_NO" name="ITEM_NO" value="${paraMap.ITEM_NO }">
			<table width="99%" cellpadding="1" cellspacing="1"
				style="height: 25px; font-size: 12px;">
				<tr>
					<td width="10%" align="left">
						<spring:message code="hrms.attItemName" />:</td>
					<td width="25%" align="left">${paItemInfo.ITEM_NAME}</td>
					<td width="5%" align="right">&nbsp;</td>
					<td align="right" height="30px;">
						<a class="l-button" style="width: 79px; height: 20px; float: right; margin-left: 10px; "
							onclick="spf_tool()"><spring:message code="tool" /></a>
						<a class="l-button" style="width: 79px; height: 20px; float: right; margin-left: 10px; "
			...
			<table width="99%" cellpadding="0" cellspacing="0"
				...
				<tr>
					...
					<td width="84%" class="l-table-edit-c">
						<textarea rows="8" cols="100" id="CONDITION" name="CONDITION"></textarea>
					</td>
				</tr>
				<tr>
					<td width="15%" class="l-table-edit-t">
						<spring:message code="formula" /></td>
					<td width="84%" class="l-table-edit-c">
						<textarea rows="8" cols="100" id="FORMULAR" name="FORMULAR" onkeyup="spf_fd();"></textarea>
					</td>
				</tr>
				<tr>
					<td width="15%" class="l-table-edit-t">
						<spring:message code="hrms.description" /></td>
					<td width="84%" class="l-table-edit-c">
