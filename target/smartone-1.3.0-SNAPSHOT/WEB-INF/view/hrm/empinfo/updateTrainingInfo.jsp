...
<script type="text/javascript">
    ...
    function spf_save(){
        if(spf_checkData()){	    
            ...
            $.post("/hrm/empinfo/updateTrainingInfo", 
                    [	    
                      	{ name: 'EMPID', value: $("#EMPID").val()},  
                      	{ name: 'TRAIN_OUT_NO', value: $("#TRAIN_OUT_NO").val()}, 
		            ...
		            <tr>
		                <td align="center" valign="middle"> 
					        <table width="99.6%" cellpadding="0" cellspacing="0" class="l-table-edit_01" border="1xp" bordercolor="#A3C0E8">
					           	<tr>
					                <td width="160px;" class="l-table-edit-t"><spring:message code="hrms.courseName"/></td>
					                <td width="60px;" class="l-table-edit-c" colspan="2"> 
						                <input type="text" name="COURSE_NAME" id="COURSE_NAME" value="${trainingInfo.COURSE_NAME }" 
					            ...
					            <tr>
					                ...
					                <td width="60px;" class="l-table-edit-c" colspan="2">  
					                	<input type="hidden" name="EMPID" id="EMPID" value="${trainingInfo.EMPID }"/>
					                	<input type="hidden" name="TRAIN_OUT_NO" id="TRAIN_OUT_NO" value="${trainingInfo.TRAIN_OUT_NO }"/>
					                	<input type="text" name="START_DATE" id="START_DATE" 
						                	 value="${trainingInfo.START_DATE }" 
					             ...
					             <tr>
					                <td width="160px;" class="l-table-edit-t"><spring:message code="hrms.classHour"/></td>
					                <td width="60px;" class="l-table-edit-c" colspan="2"> 
						                <input type="text" name="CLASS_HOUR" id="CLASS_HOUR" value="${trainingInfo.CLASS_HOUR }" 
					                    	ltype='text' validate="{required:true}"/>
					                </td>  
					             </tr>
					             <tr>   
					                ...
					                <td class="l-table-edit-c" colspan="2">
							       	   	<input type="text" name="TEACHER" id="TEACHER" value="${trainingInfo.TEACHER }" 
					                    	ltype='text' validate="{required:true}"/>  
					                </td>
					            </tr> 
					            <tr>   
					                ...
					                <td class="l-table-edit-c" colspan="2">
							       	   	<input type="text" name="TEACHING_METHODS" id="TEACHING_METHODS" value="${trainingInfo.TEACHING_METHODS }" 
					                    	ltype='text' validate="{required:true}"/>   
					                </td>
					            </tr>  
					            <tr>   
					                ...
					                <td class="l-table-edit-c" colspan="2"> 
					                    <input type="text" name="EVALUATION_METHODS" id="EVALUATION_METHODS" value="${trainingInfo.EVALUATION_METHODS }" 
					                    	ltype='text' validate="{required:true}"/> 
					                </td>
					            </tr> 
					            <tr>   
					                ...
					                <td class="l-table-edit-c" colspan="2"> 
							       	   	<input type="text" name="MARK" id="MARK" value="${trainingInfo.MARK }" 
					                    	ltype='text' validate="{required:true}"/> 
					                </td>
					            </tr> 
					            <tr>   
					                ...
					                <td class="l-table-edit-c" colspan="2">  
							       	   	<textarea rows="3" cols="" style="width: 300px" 
							       	   			id="COURSE_CONTENT" name="COURSE_CONTENT" validate="{required:true}">${trainingInfo.COURSE_CONTENT }</textarea> 
					                </td>
					            </tr> 
					             <tr>   
					                ...
					                <td class="l-table-edit-c" colspan="2">  
							       	   	<textarea rows="3" cols="" style="width: 300px" 
							       	   			id="REMARK" name="REMARK" validate="{required:true}">${trainingInfo.REMARK }</textarea> 
					                </td>
					            </tr>   
					        </table>
		        		</td>
