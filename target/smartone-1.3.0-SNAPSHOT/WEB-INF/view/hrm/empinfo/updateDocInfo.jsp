		                ...
		                <td align="center" valign="middle"> 
				            <table width="99.6%" cellpadding="0" cellspacing="0" class="l-table-edit_01" border="1xp" bordercolor="#A3C0E8">		             
				             <tr>   
				                ...
				                <td class="l-table-edit-c" colspan="2">   
				                	<input type="hidden" name="EMPID" id="EMPID" value="${DocInfo.EMPID }"/> 
				                	<input type="hidden" name="DOC_NO" id="DOC_NO" value="${DocInfo.DOC_NO }"/>
				                	<input type="text" name="OBTAINED_DATE" id="OBTAINED_DATE" 
					                	 value="${DocInfo.OBTAINED_DATE }" 
				            ...
				            <tr>
				             ...
				             <tr>   
				                ...
				                <td class="l-table-edit-c" colspan="2">
				                    <SipingSoft:selectSyCode parentCode="DocTypeCode" name="DOC_TYPE_CODE" limit="all" selected="${DocInfo.DOC_TYPE_CODE }"/> 
				                </td>
				            </tr>
				             <tr>   
				                <td  class="l-table-edit-t"><spring:message code="hrms.documentID"/></td>
				                <td class="l-table-edit-c" colspan="2">
				                    <input type="text" name="DOC_ID" id="DOC_ID" value="${DocInfo.DOC_ID }" 
				             ...
				             <tr>   
				                ...
				                <td class="l-table-edit-c" colspan="2">
				                    <input type="text" name="SIGN_DEPT" id="SIGN_DEPT" value="${DocInfo.SIGN_DEPT }" 
				                    	ltype='text' validate="{required:true}"/>   
				                </td>
				            </tr>  
				             <tr>   
				                ...
				                <td class="l-table-edit-c" colspan="2">  
						       	   	<textarea rows="3" cols="" style="width: 300px" 
						       	   			id="REMARK" name="REMARK">${DocInfo.REMARK }</textarea> 
				                </td>
				            </tr>   
				        </table> 
		       			</td>
