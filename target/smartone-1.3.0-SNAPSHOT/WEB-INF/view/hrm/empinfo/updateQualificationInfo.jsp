...
function spf_save(){
    if(spf_checkData()){
        ...
        $.post("/hrm/empinfo/updateQualificationInfo", 
                [
                    { name: 'QUAL_TYPE_CODE', value: $("#QUAL_TYPE_CODE").val()},
                    { name: 'EMPID', value: $("#EMPID").val()},    
                    { name: 'QUAL_NO', value: $("#QUAL_NO").val()},  
    ...
    <div id='layout1'>
        <form name="form1" method="post" action="" id="form1">
            <table width="100%" border="0">
                <tr>
                    <td height="2">
                        <input type="hidden" name="QUAL_NO" id="QUAL_NO" value="${qualificationInfo.NO }" />
                    </td>
                </tr>
                <tr>
                        ...
                        <table width="99.6%" cellpadding="0" cellspacing="0"
                            ...
                            <tr>
                                ...
                                <td width="60px;" class="l-table-edit-c" colspan="2"><input
                                    ...
                                    value="${qualificationInfo.EMPID }" /> 
                                    <SipingSoft:selectSyCode parentCode="QualTypeCode"
                                        name="QUAL_TYPE_CODE"
                                        selected="${qualificationInfo.QUAL_TYPE_CODE }" /></td>
                            </tr>
                            <tr>
                                <td width="160px;" class="l-table-edit-t"><spring:message
                                        code="hrms.certificateName" /></td>
                                <td width="60px;" class="l-table-edit-c" colspan="2"><input
                                    type="text" name="QUAL_CARD_NAME" id="QUAL_CARD_NAME"
                                    value="${qualificationInfo.QUAL_CARD_NAME }" /></td>
                            </tr>
                            <tr>
                                <td width="160px;" class="l-table-edit-t"><spring:message
                                        code="hrms.certificateNumber" /></td>
                                <td width="60px;" class="l-table-edit-c" colspan="2"><input
                                    type="text" name="QUAL_CARD_NO" id="QUAL_CARD_NO"
                                    value="${qualificationInfo.QUAL_CARD_NO }"
                            ...
                            <tr>
                                ...
                                <td width="60px;" class="l-table-edit-c" colspan="2"><input
                                    type="text" name="QUAL_LOCATION" id="QUAL_LOCATION"
                                    value="${qualificationInfo.QUAL_LOCATION }"
                                    validate="{required:true}" /></td>
                            </tr>
                            <tr>
                                <td width="160px;" class="l-table-edit-t"><spring:message
                                ...
                                <td width="60px;" class="l-table-edit-c" colspan="2"><input
                                    type="text" name="OPEN_DATE" id="OPEN_DATE"
                                    value="${qualificationInfo.OPEN_DATE }"
                            ...
                            <tr>
                                ...
                                <td width="60px;" class="l-table-edit-c" colspan="2"><input
                                    ...
                                    value="${qualificationInfo.END_DATE }"
                                    onclick="WdatePicker({lang:<spring:message code='dateLanguage'/>,isShowClear:false,readOnly:true})"
                                    validate="{required:true}" readonly="readonly" /></td>
                            </tr>
                            <tr>
                                ...
                                <td width="60px;" class="l-table-edit-c" colspan="2"><input
                                    type="text" name="ANNUAL_DATE" id="ANNUAL_DATE"
                                    value="${qualificationInfo.ANNUAL_DATE }"
                                    onclick="WdatePicker({lang:<spring:message code='dateLanguage'/>,isShowClear:false,readOnly:true})"
                                    validate="{required:true}" readonly="readonly" /></td>
                            </tr>
                            <tr>
                                ...
                                <td class="l-table-edit-c" colspan="2"><textarea rows="3"
                                        ...
                                        name="REMARK">${qualificationInfo.REMARK }</textarea>
                                </td>
                            </tr>
                        </table>
                    </td>
