...
<meta http-equiv="X-UA-Compatible" content="IE=edge" > 
    ...
    <script type="text/javascript">
	    ...
	    $(function ()
	   {
	    ...
	    function f_initGrid()
	    {
	    	$grid = $("#trainingInfo").ligerGrid({
	    		checkbox: false,
	            columns: [ 
	  	           	    { display: '', name: 'TRAIN_OUT_NO',width: 10,hide:1},  
						...
						{ display: '<spring:message code="hrms.description"/>', name: 'DESCRIPTION', width: 410}, 
						{ display: '<spring:message code="hrms.remarks"/>', name: 'REMARK', width: 310}
	            ], 
	    ...
	    { 
	    	...
	    	$dialog = $.ligerDialog.open({isDrag: false, 
	   		    ...
	   		    width: 600, height: 300, 
	    		url: '/hrm/empinfo/updateTrainingInfo?TRAIN_OUT_NO=' + rows.TRAIN_OUT_NO
	       	  });
	    }
	    function spf_delete()
	     {        
	     	$.ligerDialog.confirm('<spring:message code="hrms.whetherDelete"/>','<spring:message code="hrms.warning"/>', function (yes)
	         {
	         	if(yes){
	 		        ...
	 		        $.post("/hrm/empinfo/deleteTrainingInfo", 
	 		                [	
	 		                 	{ name: 'TRAIN_OUT_NO', value: rows.TRAIN_OUT_NO }
	 		                ]
	 		        , function (result)
	 		        {
...
<div id="layout1" > 
	 ...
	 <div position="top">   
				...
				<table width="99.5%" cellpadding="1" cellspacing="1" style="height:25px;font-size: 12px;">
      			...
      			<div position="left" id='trainingInfo'></div> 
	</div>
   </div> 
</body>
</html>
