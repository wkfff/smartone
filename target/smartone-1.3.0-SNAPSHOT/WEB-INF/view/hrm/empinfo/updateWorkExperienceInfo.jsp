...
function spf_save(){
    if(spf_checkData()){
        ...
        $.post("/hrm/empinfo/updateWorkExperienceInfo", 
                [
                    { name: 'EMPID', value: $("#EMPID").val()},
                    { name: 'WORK_EXPER_NO', value: $("#WORK_EXPER_NO").val()},
                            ...
                            <table width="100%" cellpadding="0" cellspacing="0" class="l-table-edit_01" border="1xp" bordercolor="#A3C0E8">
                                <tr>
                                    ...
                                    <td width="60px;" class="l-table-edit-c" colspan="2">  
                                        <input type="hidden" name="EMPID" id="EMPID" value="${workExperienceInfo.EMPID }"/>
                                        <input type="hidden" name="WORK_EXPER_NO" id="WORK_EXPER_NO" value="${workExperienceInfo.WORK_EXPER_NO }"/>
                                        <input type="text" name="START_DATE" id="START_DATE" 
                                             value="${workExperienceInfo.START_DATE }" 
                                 ...
                                 <tr>   
                                    ...
                                    <td class="l-table-edit-c" colspan="2">   
                                        <input type="text" name="END_DATE" id="END_DATE" 
                                             value="${workExperienceInfo.END_DATE }" 
                                             onclick="WdatePicker({lang:<spring:message code='dateLanguage'/>,isShowClear:false,readOnly:true})"  
                                             validate="{required:true}" readonly="readonly"/> 
                                    </td> 
                                </tr> 
                                 <tr>   
                                    ...
                                    <td class="l-table-edit-c" colspan="2">
                                        <input type="text" name="CPNY_NAME" id="CPNY_NAME" value="${workExperienceInfo.CPNY_NAME }" 
                                 ...
                                 <tr>   
                                    ...
                                    <td class="l-table-edit-c" colspan="2">
                                        <input type="text" name="DEPT_NAME" id="DEPT_NAME" value="${workExperienceInfo.DEPT_NAME }" 
                                            ltype='text' validate="{required:true}"/>   
                                    </td>
                                </tr>
                                 <tr>   
                                    ...
                                    <td class="l-table-edit-c" colspan="2">
                                        <input type="text" name="POSITION" id="POSITION" value="${workExperienceInfo.POSITION }" 
                                            ltype='text' validate="{required:true}"/>   
                                    </td>
                                </tr>  
                                 <tr>   
                                    ...
                                    <td class="l-table-edit-c" colspan="2">
                                        <textarea rows="3" cols="" style="width: 300px" 
                                                id="WORK_CONTENT" name="WORK_CONTENT" validate="{required:true}">${workExperienceInfo.WORK_CONTENT }</textarea>  
                                    </td>
                                </tr>  
                                 <tr>   
                                    ...
                                    <td class="l-table-edit-c" colspan="2">  
                                        <textarea rows="3" cols="" style="width: 300px" 
                                                id="LEAVE_REASON" name="LEAVE_REASON" validate="{required:true}">${workExperienceInfo.LEAVE_REASON }</textarea> 
                                    </td>
                                </tr>   
                            </table> 
                        </td>
