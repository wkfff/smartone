...
function spf_save(){
    if(spf_checkData()){	    
        ...
        $.post("/hrm/empinfo/addHealthInfo", 
                [	    
		                ...
		                <td align="center" valign="middle"> 
					         ...
					         <table width="100%" cellpadding="0" cellspacing="0" class="l-table-edit_01" border="1xp" bordercolor="#A3C0E8">
					             <tr>   
					                ...
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="HEIGHT" id="HEIGHT" value="" ltype='spinner' ligerui="{type:'float'}"/>
					                </td>
					                <td width="10%" class="l-table-edit-t">体重(kg)</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="WEIGHT" id="WEIGHT" value="" ltype='spinner' ligerui="{type:'float'}"/>
					                </td> 
					                <td width="10%" class="l-table-edit-t">鞋码(cm)</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="SHOE_SIZE" id="SHOE_SIZE" value="" ltype='spinner' ligerui="{type:'float'}"/>
					                </td> 
					            </tr> 
					             <tr>   
					                <td width="10%" class="l-table-edit-t">袖长(cm)</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="SLEEVE_LENGTH" id="SLEEVE_LENGTH" value="" ltype='spinner' ligerui="{type:'float'}"/>
					                </td>
					                <td width="10%" class="l-table-edit-t">衣长(cm)</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="COAT_LENGTH" id="COAT_LENGTH" value="" ltype='spinner' ligerui="{type:'float'}"/>
					                </td> 
					                <td width="10%" class="l-table-edit-t" rowspan="2">肩宽(cm)</td>
					                <td width="20%" class="l-table-edit-c" rowspan="2">
					                	<input type="text" name="SHOULDER_BREADTH" id="SHOULDER_BREADTH" value="" ltype='spinner' ligerui="{type:'float'}"/>
					                </td>
					            </tr> 
					             <tr>   
					                <td width="10%" class="l-table-edit-t">裙长(cm)</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="SKIRT_LENGTH" id="SKIRT_LENGTH" value="" ltype='spinner' ligerui="{type:'float'}"/>
					                </td> 
					                <td width="10%" class="l-table-edit-t">裤长(cm)</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="TROUSERS_LENGTH" id="TROUSERS_LENGTH" value="" ltype='spinner' ligerui="{type:'float'}"/>
					                </td> 
					            </tr>
					             <tr>   
					                <td width="10%" class="l-table-edit-t">腰围(cm)</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="WAIST" id="WAIST" value="" ltype='spinner' ligerui="{type:'float'}"/>
					                </td> 
					                <td width="10%" class="l-table-edit-t">臀围(cm)</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="HIP" id="HIP" value="" ltype='spinner' ligerui="{type:'float'}"/>
					                </td> 
					                <td width="10%" class="l-table-edit-t">胸围(cm)</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="BUST" id="BUST" value="" ltype='spinner' ligerui="{type:'float'}"/>
					                </td>
					            </tr> 
					          <tr>   
					                <td width="10%" class="l-table-edit-t">裸眼视力(左)</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="L_EYE_UCVA" id="L_EYE_UCVA" value="" ltype='spinner' ligerui="{type:'float'}"/>
					                </td>
					                <td width="10%" class="l-table-edit-t">裸眼视力(右)</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="R_EYE_UCVA" id="R_EYE_UCVA" value="" ltype='spinner' ligerui="{type:'float'}"/>
					                </td> 
					                <td width="10%" class="l-table-edit-t">眼疾(左)</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="L_EYE_DISEASE" id="L_EYE_DISEASE" value="" />
					                </td> 
					            </tr>  
					             <tr>   
					                <td width="10%" class="l-table-edit-t">矫正视力(左)</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="L_EYE_CVA" id="L_EYE_CVA" value="" ltype='spinner' ligerui="{type:'float'}"/>
					                </td>
					                <td width="10%" class="l-table-edit-t">矫正视力(右)</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="R_EYE_CVA" id="R_EYE_CVA" value="" ltype='spinner' ligerui="{type:'float'}"/>
					                </td> 
					                <td width="10%" class="l-table-edit-t">眼疾(右)</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="R_EYE_DISEASE" id="R_EYE_DISEASE" value="" />
					                </td> 
					            </tr> 
					             <tr>   
					                <td width="10%" class="l-table-edit-t">色觉</td>
					                <td width="20%" class="l-table-edit-c" colspan="5"> 
					                	<SipingSoft:selectSyCode parentCode="ColorVisionCode" name="COLOR_VISION_CODE" selected="ColorVisionCode01"/>
					                </td> 
					            </tr> 
					        </table>
					        <br>
					        <table width="100%" cellpadding="0" cellspacing="0" class="l-table-edit_01" border="1xp" bordercolor="#A3C0E8">
					          <tr>   
					                ...
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="L_EAR_AUDIBILITY" id="L_EAR_AUDIBILITY" value="" />
					                </td> 
					                <td width="10%" class="l-table-edit-t">耳疾(左)</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="L_EAR_DISEASE" id="L_EAR_DISEASE" value="" />
					                </td> 
					                <td width="10%" class="l-table-edit-t">鼻(左)</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="L_NOSE" id="L_NOSE" value="" />
					                </td>
					            </tr>  
					             <tr>   
					                <td width="10%" class="l-table-edit-t">听力(右)</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="R_EAR_AUDIBILITY" id="R_EAR_AUDIBILITY" value="" />
					                </td> 
					                <td width="10%" class="l-table-edit-t">耳疾(右)</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="R_EAR_DISEASE" id="R_EAR_DISEASE" value="" />
					                </td> 
					                <td width="10%" class="l-table-edit-t">鼻(右)</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="R_NOSE" id="R_NOSE" value="" />
					                </td>
					            </tr> 
					             <tr>   
					                <td width="10%" class="l-table-edit-t">嗅觉</td>
					                <td width="20%" class="l-table-edit-c" colspan="5">
					                    <SipingSoft:selectSyCode parentCode="OlfactoryCode" name="OLFACTORY_CODE" selected="OlfactoryCode01"/> 
					                </td> 
					            </tr>  
					        </table> 
					        <br>
					        <table width="100%" cellpadding="0" cellspacing="0" class="l-table-edit_01" border="1xp" bordercolor="#A3C0E8">
					          <tr>   
					                ...
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="BREATH" id="BREATH" value="" ltype='spinner' ligerui="{type:'int'}"/>
					                </td> 
					                <td width="10%" class="l-table-edit-t">脉搏(次/分)</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="SPHYGMUS" id="SPHYGMUS" value="" ltype='spinner' ligerui="{type:'int'}"/>
					                </td>  
					                <td width="10%" class="l-table-edit-t">发育及营养</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="GROWTH_AND_NUTRITION" id="GROWTH_AND_NUTRITION" value="" />
					                </td>  
					            </tr>  
					             <tr>   
					                <td width="10%" class="l-table-edit-t">收缩压</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="BLOOD_PRESSURE_MAX" id="BLOOD_PRESSURE_MAX" value="" ltype='spinner' ligerui="{type:'int'}"/>
					                </td> 
					                <td width="10%" class="l-table-edit-t">舒张压</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="BLOOD_PRESSURE_MIX" id="BLOOD_PRESSURE_MIX" value="" ltype='spinner' ligerui="{type:'int'}"/>
					                </td>  
					                <td width="10%" class="l-table-edit-t">腹部检查</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="ABDOMINAL_CHECK" id="ABDOMINAL_CHECK" value="" />
					                </td> 
					            </tr> 
					             <tr>   
					                <td width="10%" class="l-table-edit-t">血糖</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="BLOOD_SUGAR" id="BLOOD_SUGAR" value="" />
					                </td> 
					                <td width="10%" class="l-table-edit-t">肺</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="HBSAG" id="HBSAG" value="" />
					                </td>  
					                <td width="10%" class="l-table-edit-t">皮肤</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="HBS" id="HBS" value="" />
					                </td>   
					            </tr>  
					             <tr>   
					                ...
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="PT" id="PT" value="" />
					                </td>  
					                <td width="10%" class="l-table-edit-t">大便培养</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="HBE" id="HBE" value="" />
					                </td>  
					            </tr> 
					             <tr>   
					                <td width="10%" class="l-table-edit-t">血常规</td>
					                <td width="20%" class="l-table-edit-c">
					                	<input type="text" name="CBC" id="CBC" value="" />
					                </td> 
					                <td width="10%" class="l-table-edit-t">ABO血型</td>
					                <td width="20%" class="l-table-edit-c">
										<SipingSoft:selectSyCode parentCode="BloodTypeCode" name="BLOOD_TYPE_CODE" limit="all"/> 
					                </td>  
					                <td width="10%" class="l-table-edit-t">RH血型</td>
					                <td width="20%" class="l-table-edit-c">
										<SipingSoft:selectSyCode parentCode="RHTypeCode" name="RH" limit="all"/>  
					                </td>  
					            </tr> 
					             <tr>   
					                <td width="10%" class="l-table-edit-t">胸透</td>
					                <td width="20%" class="l-table-edit-c" colspan="5">
					                	<input type="text" name="HBEAG" id="HBEAG" value="" />
					                </td>  
					            </tr>  
					        </table>   
					        <br>
					        <table width="100%" cellpadding="0" cellspacing="0" class="l-table-edit_01" border="1xp" bordercolor="#A3C0E8">
					            <tr>   
					                ...
					                <td width="20%" class="l-table-edit-c"> 
										<SipingSoft:selectSyCode parentCode="CheckWhether" name="CHECK_YN_CODE" limit="all"/>
					                </td>
					                <td width="10%" class="l-table-edit-t"><spring:message code="hrms.examinationResult"/></td>
					                <td width="20%" class="l-table-edit-c">
										<SipingSoft:selectSyCode parentCode="CheckResult" name="CHECK_RESULT_CODE" limit="all"/>
					                </td> 
					            </tr>   
					            <tr>
