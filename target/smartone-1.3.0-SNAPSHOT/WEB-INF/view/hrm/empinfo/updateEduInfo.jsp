...
function f_save(){
    if(spf_checkData()){	    
        ...
        $.post("/hrm/empinfo/updateEduInfo", 
                [	   
	               	{ name: 'EMPID', value: $("#EMPID").val()},  
	               	{ name: 'EDUC_NO', value: $("#EDUC_NO").val()},  
					        ...
					        <table width="99.6%" cellpadding="0" cellspacing="0" class="l-table-edit_01" border="1xp" bordercolor="#A3C0E8">
					            <tr>
					                ...
					                <td width="60px;" class="l-table-edit-c" colspan="2">  
					                	<input type="hidden" name="EMPID" id="EMPID" value="${EduInfo.EMPID }"/>
					                	<input type="hidden" name="EDUC_NO" id="EDUC_NO" value="${EduInfo.EDUC_NO }"/>
					             ...
					             <tr>   
					                ...
					                <td class="l-table-edit-c" colspan="2">
							       	   	<textarea rows="3" cols="" style="width: 300px" 
							       	   			id="CONTENT" name="CONTENT" validate="{required:true}">${EduInfo.CONTENT }</textarea>  
					                </td>
					            </tr>  
					             <tr>   
