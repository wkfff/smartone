...
function spf_save(){
    if(spf_checkData()){	    
        ...
        $.post("/hrm/empinfo/updateLanuageInfo", 
                [	   
                  	{ name: 'LANGUAGE_TYPE_CODE', value: $("#LANGUAGE_TYPE_CODE").val()},  
                  	{ name: 'EMPID', value: $("#EMPID").val()},   
                  	{ name: 'NO', value: $("#NO").val()},  
                  	{ name: 'EXAM_TYPE_CODE', value: $("#EXAM_TYPE_CODE").val()},
                  	{ name: 'LAN_INSTITUTE', value: $("#LAN_INSTITUTE").val()},
                  	{ name: 'LANGUAGE_LEVEL_CODE', value: $("#LANGUAGE_LEVEL_CODE").val()},
...
{    
	var LANGUAGE_TYPE_CODE = $("#LANGUAGE_TYPE_CODE").val(); 
	var EXAM_TYPE_CODE = $("#EXAM_TYPE_CODE").val(); 
	var LAN_INSTITUTE = $("#LAN_INSTITUTE").val(); 
	var LANGUAGE_LEVEL_CODE = $("#LANGUAGE_LEVEL_CODE").val(); 
	var MARK = $("#MARK").val();  
	var OPEN_DATE = $("#OPEN_DATE").val();  
	var DESCRIPTION = $("#DESCRIPTION").val();   
		 
    if (LANGUAGE_TYPE_CODE == null || LANGUAGE_TYPE_CODE == "") { 
    ...
    if (LAN_INSTITUTE == null || LAN_INSTITUTE == "") { 
       	 $.ligerMessageBox.warn('<spring:message code="hrms.warning"/>', '<spring:message code="hrms.certificateName"/>'+". " + '<spring:message code="input.required"/>') ; 
       	 return false; 
    }  
    if (LANGUAGE_LEVEL_CODE == null || LANGUAGE_LEVEL_CODE == "") { 
       	 $.ligerMessageBox.warn('<spring:message code="hrms.warning"/>', '<spring:message code="hrms.grade"/>'+". " + '<spring:message code="input.required"/>') ; 
       	 return false; 
    }  
    if (MARK == null || MARK == "") { 
      	 $.ligerMessageBox.warn('<spring:message code="hrms.warning"/>', '<spring:message code="hrms.fraction"/>'+". " + '<spring:message code="input.required"/>') ; 
      	 return false; 
    }  
					        ...
					        <table width="99.6%" cellpadding="0" cellspacing="0" class="l-table-edit_01" border="1xp" bordercolor="#A3C0E8">
					             <tr>
					                ...
					                <td width="60px;" class="l-table-edit-c" colspan="2">   
					                	<input type="hidden" name="NO" id="NO" value="${lanuageInfo.NO }"/>
					                	<input type="hidden" name="EMPID" id="EMPID" value="${lanuageInfo.EMPID }"/>
					                	<SipingSoft:selectSyCode parentCode="LanguageTypeCode" name="LANGUAGE_TYPE_CODE" selected="${lanuageInfo.QUAL_TYPE_CODE }"/> 
					             ...
					             <tr>
					                ...
					                <td width="60px;" class="l-table-edit-c" colspan="2">   
					                	<SipingSoft:selectSyCode parentCode="LanguageExamCode" name="EXAM_TYPE_CODE" selected="${lanuageInfo.EXAM_TYPE_CODE }"/> 
					                </td>  
					             </tr>
					             <tr>
					                <td width="160px;" class="l-table-edit-t"><spring:message code="hrms.certificateName"/></td>
					                <td width="60px;" class="l-table-edit-c" colspan="2">   
					                	<input type="text" name="LAN_INSTITUTE" id="LAN_INSTITUTE" value="${lanuageInfo.LAN_INSTITUTE }" validate="{required:true}"/> 
					                </td>  
					             </tr>
					             <tr>
					                <td width="160px;" class="l-table-edit-t"><spring:message code="hrms.grade"/></td>
					                <td width="60px;" class="l-table-edit-c" colspan="2">   
					                	<SipingSoft:selectSyCode parentCode="LanguageLevelCode" name="LANGUAGE_LEVEL_CODE" selected="${lanuageInfo.LANGUAGE_LEVEL_CODE }"/> 
					                </td>  
					             </tr>
					             <tr>
					                <td width="160px;" class="l-table-edit-t"><spring:message code="hrms.fraction"/></td>
					                <td width="60px;" class="l-table-edit-c" colspan="2">   
					                	<input type="text" name="MARK" id="MARK" value="${lanuageInfo.MARK }" ltype='spinner' ligerui="{type:'float'}"/> 
					                </td>  
					             </tr>
					            <tr>
					             ...
					             <tr>   
					                ...
					                <td class="l-table-edit-c" colspan="2">
							       	   	<textarea rows="3" cols="" style="width: 300px" 
							       	   			id="DESCRIPTION" name="DESCRIPTION" >${lanuageInfo.DESCRIPTION }</textarea>  
					                </td>
					            </tr>  
					             <tr>   
					                ...
					                <td class="l-table-edit-c" colspan="2">  
							       	   	<textarea rows="3" cols="" style="width: 300px" 
							       	   			id="REMARK" name="REMARK" >${lanuageInfo.REMARK }</textarea> 
					                </td>
					            </tr>   
					        </table>		 
		        		</td>
