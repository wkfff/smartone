...
<script type="text/javascript">
	...
	*/ 
	...
	function spf_refresh(){
		location.href="/hrm/transferOrder/viewPlurality?MENU_CODE=hr0204";
	}
</script>
	<style type="text/css">
	body {
				...
				<table width="99.5%" align="center" cellpadding="0" cellspacing="0"
					...
					<tr>
						<td width="15%" class="l-table-edit-t">
							<spring:message code="hrms.dept"/><font color="red">*</font></td>
						...
						<td class="l-table-edit-c" width="35%">
							<SipingSoft:selectPost name="POST_ID" />
						</td>
					</tr>
					<tr>
						<td class="l-table-edit-t" width="15%">
					...
					<tr>
						<td class="l-table-edit-t" width="15%">
							<spring:message code="hrms.reason"/><font color="red">*</font>
						</td>
						<td class="l-table-edit-c" colspan="3" ><textarea rows=""
							cols="" style="height: 100px; width: 600px" id="REASON"
							name="REASON" validate="{required:true}"></textarea></td>
					</tr>
				</table>
			</div>
		</div>
