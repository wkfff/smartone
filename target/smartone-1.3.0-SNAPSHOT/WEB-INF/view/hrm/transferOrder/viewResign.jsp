    ...
    */ 
        ...
        if(spf_checkData()){ 
            ...
            $.post("/hrm/transferOrder/saveTransferOrder", 
                [
                    ...
                    { name: 'RESIGN_TYPE_CODE', value: $("#RESIGN_TYPE_CODE").val() },
                    { name: 'RESIGN_REASON', value: $("#RESIGN_REASON").val() },
                    { name: 'RESIGN_DATE', value: $("#START_DATE").val() },
                    { name: 'TRANS_CODE', value: '${TRANS_CODE}' },
                    { name: 'TRANS_NO', value: '${TRANS_NO}' },
                    { name: 'REMARK', value: '' },
                    { name: 'TYPE', value: 'resign'}
                ],
            function (result){
    ...
    function spf_checkData(){
        ...
        if ($("#START_DATE").val() == null || $("#START_DATE").val() == "") { 
            $.ligerMessageBox.warn('<spring:message code="hrms.warning"/>', '<spring:message code="hrms.leftDate" />'+". " + '<spring:message code="input.required"/>') ; 
            return false; 
        }
        if ($("#RESIGN_REASON").val() == null || $("#RESIGN_REASON").val() == "") { 
            $.ligerMessageBox.warn('<spring:message code="hrms.warning"/>', '<spring:message code="hrms.leftReason" />'+". " + '<spring:message code="input.required"/>') ; 
            return false; 
        }
        return true; 
    }
    function spf_refresh(){
        location.href="/hrm/transferOrder/viewResign?MENU_CODE=hr0206";
    }
</script>
    <style type="text/css">
    body {
            ...
            <div position="top">
                ...
                <table width="99.5%" align="center" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        ...
                        <td class="l-table-edit-c" width="85%" colspan="3"><input type="text"
                            name="EMP_NAME" id="EMP_NAME" value=""
                            validate="{required:true}" /> <input type="hidden"
                            name="EMPID" id="EMPID" value="" /></td>
                    </tr>
                    <tr>
                        <td class="l-table-edit-t" width="15%"><spring:message code="hrms.leftType"/><font color="red">*</font></td>
                        <td class="l-table-edit-c" width="35%">
                            <SipingSoft:selectSyCode parentCode="ResignTypeCode" name="RESIGN_TYPE_CODE"/>
                        </td> 
                        <td class="l-table-edit-t" width="15%">
                            <spring:message code="hrms.leftDate"/><font color="red">*</font>
                        </td>
                        <td class="l-table-edit-c" width="35%">
                            <input type="text"
                    ...
                    <tr>
                        <td class="l-table-edit-t" width="15%">
                            <spring:message code="hrms.leftReason"/>
                        </td>
                        <td class="l-table-edit-c" colspan="3" ><textarea rows=""
                            cols="" style="height: 100px; width: 600px" id="RESIGN_REASON"
                            name="RESIGN_REASON" validate="{required:true}"></textarea></td>
                    </tr>
                </table>
            </div>
        </div>
