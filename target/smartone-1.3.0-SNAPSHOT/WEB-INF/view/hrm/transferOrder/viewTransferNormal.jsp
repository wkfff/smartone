   ...
   <meta http-equiv="X-UA-Compatible" content="IE=edge" >
    ...
    function f_initGrid()
    {
    	$grid = $("#empInfo").ligerGrid({
            ...
            { display: '<spring:message code="hrms.dept"/>', name: 'DEPTNAME', width: 180},
            { display: '<spring:message code="hrms.postGroup"/>', name: 'POST_GROUP_NAME', width: 90},  
            ...
            { display: '<spring:message code="hrms.ProposeEndDate"/>', name: 'END_PROBATION_DATE', width: 120},  
            ...
            parms: [	
                   	{ name: 'OFF_PROBATION', value: 'YES'},
                	{ name: 'TURN_TYPE_CODE', value: $("#TRANS_CODE").attr('value')}
                   ],
    ...
    function spf_search()
    {
    	$grid.setOptions({ parms: [	
	                        	...
	                        	{ name: 'DEPTID', value: $("#DEPTID").attr('value')},
	                           	{ name: 'OFF_PROBATION', value: 'YES'},
	                        	{ name: 'S_END_PROBATION_DATE', value: $("#S_END_PROBATION_DATE").attr('value')},
	                        	{ name: 'E_END_PROBATION_DATE', value: $("#E_END_PROBATION_DATE").attr('value')},
	                        	{ name: 'TURN_TYPE_CODE', value: $("#TRANS_CODE").attr('value')}
    	                           ],
    	                   newPage: 1
    	                 }); //设置数据参数
       ...
       $(rows).each(function (index, row)
             {
	    	   if(this.__status != null && this.__status == 'update'){
		             ...
		             var statusCode = "";
	    		     if (transCode == "TurnType0010"){
	    		    	 statusCode = "EmpStatus6";
		             }else{
	    		    	 statusCode = "EmpStatus2";
		             }
	           ...
	           <tr>
	             ...
	             <tr> 
	               <td  class="l-table-edit-t">
	               		<spring:message code="hrms.ProposeEndDate"/></td>
	               <td  class="l-table-edit-c">
				      	 <input type="text" name="S_END_PROBATION_DATE" id="S_END_PROBATION_DATE" 
						                	 value="" size="30"
						                	 onclick="WdatePicker({lang:<spring:message code='dateLanguage'/>,isShowClear:true,readOnly:true,dateFmt:'yyyy-MM-dd'})"  
						                	 readonly="readonly"/>  
						 ~
				      	 <input type="text" name="E_END_PROBATION_DATE" id="E_END_PROBATION_DATE" 
						                	 value="" size="30"
						                	 onclick="WdatePicker({lang:<spring:message code='dateLanguage'/>,isShowClear:true,readOnly:true,dateFmt:'yyyy-MM-dd'})"  
						                	 readonly="readonly"/> 
	               </td>
	               <td  class="l-table-edit-t">
	               		<spring:message code="hrms.offProbationType"/></td>
	               <td  class="l-table-edit-c">
	                    <SipingSoft:selectSyCode parentCode="TurnType" name="TRANS_CODE" selected="TurnType0010" limit="all" onChange="spf_search();"/>
	               </td> 
	           </tr>
	       </table>
