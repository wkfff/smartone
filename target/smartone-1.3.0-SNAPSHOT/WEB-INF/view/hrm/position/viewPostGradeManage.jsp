   ...
   // 初始调用
    ...
    { 
        $grid = $("#gridInfo").ligerGrid({
            ...
            url: '/hrm/position/getPostGradeInfo',
    ...
    function spf_save(){
        ...
        $.post("/hrm/position/updatePostGradeInfo", 
                [
    ...
    function spf_delete()
    {
        $.ligerDialog.confirm('<spring:message code="hrms.whetherDelete"/>','<spring:message code="hrms.warning"/>', function (yes)
        {
            if(yes){
                ...
                $.post("/hrm/position/deletePostGradeInfo", 
                        [   
     ...
     function spf_add(){
        $dialog = $.ligerDialog.open({isDrag: false, title:'<spring:message code="hrms.add"/>', 
             width: 800, height: 260, url: '/hrm/position/addPostGradeInfo'
          });
    }
    </script>
