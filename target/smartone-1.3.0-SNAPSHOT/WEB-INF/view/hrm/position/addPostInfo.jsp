                        ...
                        <table width="99.6%" cellpadding="0" cellspacing="0" class="l-table-edit_01" border="1xp" bordercolor="#A3C0E8">
                            <tr>
                                ...
                                <td class="l-table-edit-c" >
                                    <input name="POST_ID" type="text" id="POST_ID" value="" 
                             ...
                             <tr>
                                ...
                                <td class="l-table-edit-c">
                                    <input name="POST_NAME" type="text" id="POST_NAME" value="" 
                                    ltype="text" validate="{required:true}" />
                                </td>
                                <td class="l-table-edit-t"><spring:message code="hrms.englishName"/></td>
                                <td class="l-table-edit-c">
                                    <input name="POST_EN_NAME" type="text" id="POST_EN_NAME" value="" 
                                    ltype="text"  validate="{required:true}" />
                                </td> 
                            </tr> 
                             <tr> 
                             <td class="l-table-edit-t"><spring:message code="hrms.position"/></td>
                               <td class="l-table-edit-c">
                                    <SipingSoft:selectPosition name="POSITION_ID" limit="all" />
                               </td>
                               <td class="l-table-edit-t"><spring:message code="hrms.postGroup"/></td>
                               <td class="l-table-edit-c">
                                    <SipingSoft:selectPostGroup name="POST_GROUP_ID" limit="all" />
                               </td>
                             </tr>
                            <tr>   
