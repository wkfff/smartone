   ...
   <%@ include file="/WEB-INF/view/web/inc/validateForm.jsp"%>
    ...
    function f_save(){
        if(checkData()){
            ...
            var options = {
                url:'/hrm/position/addPostGroupInfo',
                type:'POST',
                ...
                <table width="99.6%" cellpadding="0" cellspacing="0" class="l-table-edit_01" border="1xp" bordercolor="#A3C0E8">
                    <tr>
                        ...
                        <td class="l-table-edit-c" >
                            <input name="POST_GROUP_ID" type="text" id="POST_GROUP_ID" value="" 
                            ltype="text" validate="{required:true}" class="myInputs"/>
                        </td>
                     ...
                     <tr>   
                        ...
                        <td class="l-table-edit-c">
                            <input name="POST_GROUP_NAME" type="text" id="POST_GROUP_NAME" value="" 
                            ltype="text" validate="{required:true}" />
                        </td>
                        <td class="l-table-edit-t"><spring:message code="hrms.englishName"/></td>
                        <td class="l-table-edit-c">
                            <input name="POST_GROUP_EN_NAME" type="text" id="POST_GROUP_EN_NAME" value="" 
                            ltype="text"  validate="{required:true}" />
                        </td>
                    </tr> 
                    <tr>   
