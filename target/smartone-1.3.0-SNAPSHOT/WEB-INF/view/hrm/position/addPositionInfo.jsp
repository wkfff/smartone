   ...
   <%@ include file="/WEB-INF/view/web/inc/validateForm.jsp"%>
    ...
    function f_save(){
        if(checkData()){
            ...
            var options = {
                url:'/hrm/position/addPositionInfo',
                type:'POST',
            ...
            <table width="99.6%" cellpadding="0" cellspacing="0" class="l-table-edit_01" border="1xp" bordercolor="#A3C0E8">
                <tr>
                    ...
                    <td class="l-table-edit-c" colspan="3">
                        <input name="POSITION_ID" type="text" id="POSITION_ID" value="" 
                 ...
                 <tr>
                    ...
                    <td class="l-table-edit-c">
                        <input name="POSITION_NAME" type="text" id="POSITION_NAME" value="" 
                        ltype="text" validate="{required:true}" />
                    </td>
                    <td class="l-table-edit-t"><spring:message code="hrms.englishName"/></td>
                    <td class="l-table-edit-c">
                        <input name="POSITION_EN_NAME" type="text" id="POSITION_EN_NAME" value="" 
                        ltype="text"  validate="{required:true}" />
                    </td> 
                </tr>
                 <tr> 
                   ...
                   <td class="l-table-edit-c">
                        <SipingSoft:selectPostGrade name="POST_GRADE_ID" limit="all" />
                   </td>
