    ...
    function f_initGrid(){
        $grid = $("#empInfo").ligerGrid({
            ...
            columns: [
                        ...
                        { display: '<spring:message code="ass.jobLevel"/>', name: 'POST_LEVEL_NAME', width: 120}, 
            ...
            parms: [
                    { name: 'TRANS_CODE',value: 'TransCode_100'}
                   ],
...
//          $.ligerMessageBox.error('<spring:message code="hrms.warning"/>', '<spring:message code="hrms.editData"/>') ;
    ...
    function spf_insExcel(colums){
        ...
        if (s_date == '' || e_date == '') {
            $.ligerMessageBox.warn('<spring:message code="hrms.warning"/>', '<spring:message code="hrm.pleasein"/>');
            return ;
        }
        ...
        location.href='/hrm/transferOrder/getTransferOrderByExcel?PA_MONTH=' + attMonth+'&S_DATE='
                ...
                +'&sheetTitle=<spring:message code="hrm.staffEntryInformation"/>';
