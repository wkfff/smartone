   ...
   <meta http-equiv="X-UA-Compatible" content="IE=edge" >
    ...
    function f_initGrid()
    {
        $grid = $("#empInfo").ligerGrid({
            checkbox: true,
            columns: [
                        { display: '', name: 'PLU_NO', width: 10,hide:1},
                        ...
                        { display: '<spring:message code="hrms.reason"/>', name: 'REASON', width: 200,
            ...
            url: '/hrm/searchTransferOrder/getPluralityInfoList',
            parms: [
                    { name: 'TRANS_CODE',value: 'TransCode_150'}
                   ],
       ...
       $(rows).each(function (index, row){
           ...
           if(this.CANCEL_REMARK == null || this.CANCEL_REMARK == 'undefined' ){ 
                    $.ligerMessageBox.warn('<spring:message code="hrms.warning"/>', '<spring:message code="hrms.cancelRemarks"/>'  +". " + '<spring:message code="input.required"/>') ; 
                     ...
                     jsonData += '"PLU_NO":"'+this.PLU_NO+'",';
                     jsonData += '"CANCEL_REMARK":"'+this.CANCEL_REMARK+'",';
                     jsonData += '"rollbackType":"Plurality"';
                     jsonData += '}';
                 }
        });
        jsonData += ']';
                ...
                $.ligerDialog.waitting('<spring:message code="hrms.canceling"/>');
                   $.post("/hrm/searchTransferOrder/cancelDoc2", 
                           [
                                ...
                                { name: 'rollbackType', value: 'Plurality' }
                           ],
                   function (result){
