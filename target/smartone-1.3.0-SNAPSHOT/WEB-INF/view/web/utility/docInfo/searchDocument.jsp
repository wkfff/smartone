...
<script type="text/javascript"> 
    ...
    function f_initGrid()
    {
    	$grid = $("#docInfo").ligerGrid({
    		//checkbox: true,   		
    		columns: [
			            { display: '文档编号', name: 'DOC_ID', width: 90},
						{ display: '文档名称', name: 'DOC_NAME', width: 90},
						{ display: '文档版本', name: 'DOC_VERSION', width: 90},
						{ display: '描述', name: 'DESCRIPTION', width: 220}
		            ],
            enabledEdit: true,usePager: true, rownumbers:true,
            url: '/utility/docInfo/getDocList',
            parms: [
                   ],
    ...
    function spf_search()
    {
    	$grid.setOptions({ parms: [	
									...
									{ name: 'DOC_STATUS_CODE', value: $("#DOC_STATUS_CODE").attr('value')}
    	                           ],
    	                   newPage: 1
    	                 }); //设置数据参数
...
<body style="padding: 2px">
	<div id="layout1">
			...
			<table width="99.6%" cellpadding="0" cellspacing="0" class="l-table-edit_01" border="1xp" bordercolor="#A3C0E8">
				<tr>
					...
					<td width="35%" class="l-table-edit-c"><input name="keyWord"
	 				...
	 				<td width="15%" class="l-table-edit-t">文档状态</td>
					<td width="35%" class="l-table-edit-c">    
						<SipingSoft:selectSyCode parentCode="DocumentStatusCode" name="DOC_STATUS_CODE" onChange="spf_search();" limit="all"/>
					</td>
				</tr>
			</table>
		...
		<div position="center" id='docInfo'></div>
		</div>
</body>
</html>
