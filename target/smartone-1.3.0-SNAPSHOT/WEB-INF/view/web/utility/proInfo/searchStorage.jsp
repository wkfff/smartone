    ...
    $(function ()
   {
    ...
    function f_initGrid()
    {
    	$grid = $("#productInfo").ligerGrid({
    		//checkbox: true,   		
    		columns: [   
			            { display: '仓库编号', name: 'PRO_STORAGE_ID', width: 90},
			            { display: '仓库名称', name: 'STORAGE_NAME', width: 200},
			            { display: '仓库地点', name: 'PLACE', width: 200},
     ...
     <div position="center" id='' title=' ' style="border: 0px;"> 
		<div position="top">
			<table width="99.6%" cellpadding="0" cellspacing="0"
				...
				<tr>
					<td width="15%" class="l-table-edit-t">仓库名称<spring:message
							code="keyWord" /></td>
