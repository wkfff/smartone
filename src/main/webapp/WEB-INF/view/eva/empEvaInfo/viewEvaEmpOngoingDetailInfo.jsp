...
<script type="text/javascript">
	...
	function spf_save(flag, activity) {
		...
		if ($Flag == 'I') {
			...
			strURL = "/eva/empEvaInfo/updateEvaEmpOngoingItemInfo";
			$(rows)
					.each(
							function(index, row) {
								if (this.EV_1_SCORE == '0'
										|| this.EV_1_SCORE == null
										|| this.EV_1_SCORE == 'undefined') {
									$.ligerMessageBox
											.warn(
	...
	<div id="layout1">
		...
		<div position="center">
			<div id="navtab1"
				...
				<div title='评价项目'>
					<c:if
						test="${paraMap.EV_1_ITEM_FLAG == '0' || paraMap.EV_1_ITEM_FLAG == '1'}">
				...
				<div title='工作计划'>
					<%-- 
					       <table cellpadding="0" cellspacing="0" class="l-table-edit" height="30px;"> 
					           <tr>
					                <td align="left"> 
		               						<a class="l-button" style="width:79px; height:20px; float: left; margin-left:10px;" onclick="spf_save('W',1)"><spring:message code="hrms.save"/></a>  
		               					    <a class="l-button" style="width:79px; height:20px; float: left; margin-left:10px;" onclick="spf_save('W',2)"><spring:message code="submit"/></a>   
								    </td>
					           </tr>  
				       		</table> 	 
				       		--%>
