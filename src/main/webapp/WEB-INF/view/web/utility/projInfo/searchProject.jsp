...
<meta http-equiv="X-UA-Compatible" content="IE=edge" >
    ...
    $(function ()
   {
    ...
    function f_initGrid()
    {
    	$grid = $("#projectInfo").ligerGrid({
    		//checkbox: true,   		
    		columns: [   
			            { display: '项目编号', name: 'PRO_NO', width: 150},
			            { display: '项目名称', name: 'PRO_NAME', width: 150},
     ...
     <div position="center" id='' title=' ' style="border: 0px;"> 
		<div position="top">
			<table width="99.6%" cellpadding="0" cellspacing="0"
				...
				<tr>
					<td width="15%" class="l-table-edit-t">项目名称<spring:message
							code="keyWord" /></td>
