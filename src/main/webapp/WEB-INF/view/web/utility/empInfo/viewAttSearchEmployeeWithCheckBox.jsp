	...
	grid =$("#arSearchEmp").ligerGrid({	
	      checkbox: true,					               
	           columns: [
	           	...
	           	{ display: '<spring:message code="hrms.name"/>', name: 'CHINESENAME', align: 'left'},
	           	{ display: '<spring:message code="hrms.dept"/>', name: 'DEPTNAME', align: 'left' }
	           ], 
	           usePager: true, rownumbers: true,dataAction: 'server', root: 'arSearchEmployeeList', record: 'arSearchEmployeeCnt', 
	           url: '/utility/empInfo/getArSearchEmployeeList?SELECT_TYPE=${param.SELECT_TYPE}',               
	           width: '99.6%',	           
	           height: '100%',
...
<div id="layout1" > 
      ...
      <div position="center" id='arSearchEmp' ></div>
</div>   
</body>
</html>
