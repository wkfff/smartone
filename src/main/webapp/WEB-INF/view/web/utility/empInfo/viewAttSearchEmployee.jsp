	 ...
	 var $grid ;
	    ...
	    function f_initGrid(){
			$grid =$("#arSearchEmp").ligerGrid({						               
		            ...
		            url: '/utility/empInfo/getAttSearchEmployeeList?AR_ADMIN_ID=${paraMap.AR_ADMIN_ID}',  
		            width: '99.6%',	           
					           ...
					           <tr> 
					               <td class="l-table-edit-t"><spring:message code="keyWord"/></td>
					                ...
					                <td class="l-table-edit-c" colspan="3">
					                	<SipingSoft:deptTree name="DEPTID" limit="hr" onChange="spf_search();" selected="${paraMap.DEPTID}"/>
