    ...
    function f_initGrid() {
        $grid = $("#hrSearchEmp").ligerGrid({
            columns : [ {
                ...
                display : '<spring:message code="hrms.company"/>',
                name : 'CPNY_NAME',
                width : 140
            } ],
            usePager : true,
    ...
    <div id="layout1">
        <div position="top">
                    ...
                    <td align="center" valign="middle">
                        <table width="99.6%" align="center" cellpadding="0" cellspacing="0" class="l-table-edit_01" border="1xp" bordercolor="#A3C0E8">
                            <tr>
                                ...
                                <td class="l-table-edit-c"><input type="text" name="keyWord" id="keyWord" /></td>
                                <td class="l-table-edit-t"><spring:message code="hrms.dept" /></td>
                                <td class="l-table-edit-c"><SipingSoft:deptTree name="DEPTID" limit="hr" onChange="spf_search()" /></td>
                            </tr>
                        </table>
                    </td>
                </tr>
            ...
            <table cellpadding="0" cellspacing="0" class="l-table-edit">
                <tr>
                    <td align="left" height="30px"><a class="l-button" style="width: 79px; height: 20px; float: left; margin-left: 10px;" onclick="spf_search()"><spring:message code="search" /></a>
                    </td>
                </tr>
            </table>
        </div>
