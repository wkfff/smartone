   ...
   <%@ include file="/WEB-INF/view/web/inc/validateForm.jsp"%>
    ...
    function f_save(){
    	if(spf_checkData())
    	{
	        ...
	        var options = {	                        
	            url:'/upload/fileUpload/uploadContractAppendix',
	            type:'POST',	                        
							...
							<table width="99.6%" cellpadding="1" cellspacing="1" style="height:30px;font-size: 12px;">
					          <tr>  
					          	...
					          	<td height="30px;" align="left">
									...
									<input type="hidden" name="CONTRACT_NO" id="CONTRACT_NO" value="${paraMap.CONTRACT_NO}" /> 
							    </td> 
					        </tr>  
					        <tr>    
					          	<td height="30px;" align="left">
					        ...
					        <tr>    
					          	...
					          	<td height="30px;"> 
									 <div align="left" style="font-weight: bold;">
										<a style="color:#ff0000">提示：上传格式为gif、jpg、jpeg、png、doc或docx。</a>
						 			</div>  
						        </td>  
					        </tr>                       
					        </table>
