   ...
   <%@ include file="/WEB-INF/view/web/inc/validateForm.jsp"%>
    ...
    function f_save(){
    	if(spf_checkData())
    	{
	        ...
	        var options = {	                        
	            url:'/upload/fileUpload/uploadProImage',
	            type:'POST',	                        
							...
							<table width="99.6%" cellpadding="1" cellspacing="1" style="height:30px;font-size: 12px;">
					          <tr>  
					          	...
					          	<td height="30px;" align="left">
									...
									<input type="hidden" name="PRODUCT_ID" id="PRODUCT_ID" value="${paraMap.PRODUCT_ID}" /> 
									<input type="hidden" name="PRODUCT_NO" id="PRODUCT_NO" value="${paraMap.PRODUCT_NO}" /> 
							    </td> 
					        </tr>  
					        <tr>    
					          	<td height="30px;" align="left">
