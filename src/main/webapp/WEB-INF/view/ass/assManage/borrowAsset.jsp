    ...
    */
    function spf_application(){
        if(spf_checkData()){
            ...
            $.post("/ess/infoApp/addToolAppAss",
                [
            ...
            function (result){
                ...
                if (result == "Y"){
                    $.ligerDialog.success('申请成功<spring:message code=""/>！','<spring:message code="hrms.warning"/>', function (){
                        $("#BORROW_DATE").val('');
                        $("#RETURN_DATE").val('');
                        $("#TOOL_REMARK").val('');
                        $("#TOOL_CONTENT").val('');
            ...
            <div position="top">
                <form name="form1" method="post" action="" id="form1">
                    <table width="99.5%" cellpadding="1" cellspacing="1"
                        ...
                        <tr>
                            ...
                            <td width="25%" align="left" style="font-weight: bold;">
                                <spring:message code="ass.assetsToBorrow"/></td>
                    ...
                    <table width="99.5%" align="center" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            <td class="l-table-edit-t" width="15%"><spring:message code="hrms.borrowItems"/></td>
                            ...
                            <td class="l-table-edit-t"><spring:message code="hrms.borrowingDate"/></td>
