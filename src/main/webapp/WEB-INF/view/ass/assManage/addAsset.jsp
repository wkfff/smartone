...
/*  *************************************************** */
        ...
        if(spf_checkData()){                  
             ...
             $.post("/ass/assManage/transferAsset", 
                     [
                        ...
                        { name: 'ID_TYPE', value: $("input[name='id_type']:checked").val()},
    ...
    {     
        ...
        if($("#TipID").text() == "不可用"){
             $.ligerMessageBox.warn('<spring:message code="hrms.warning"/>', '<spring:message code="ass.assetID"/>'+". " + '<spring:message code="hrms.unavailable"/>') ; 
             return false; 
        }
    ...
    {    
         if(id==1){
             ...
             if($("#ASSET_ID").val()==""||$("#ASSET_ID").val()==null){
    ...
    function changeAss(v){
        if(v=="AssetCategory001"){
            $("#ASSET_ID").val("CTULG");
        }
        if(v=="AssetCategory002"){
            $("#ASSET_ID").val("CTUEG");
        }
        if(v=="AssetCategory003"){
            $("#ASSET_ID").val("CTUOS");
        }
        if(v=="AssetCategory007"){
            $("#ASSET_ID").val("CTUAG");
        }
        if(v=="PC"){
            $("#ASSET_ID").val("CTUPC");
    ...
    <div id="layout1" style="width: 99.6%; margin: 0; padding: 0;">
        ...
        <table width="99.6%" cellpadding="1" cellspacing="1"
            ...
            <tr>
                ...
                <td width="25%" align="left" style="font-weight: bold;"><spring:message code="ass.basicInformation"/></td>
            ...
            <tr>
                ...
                <td width="20%" class="l-table-edit-c" id="categorySelection">
                    <SipingSoft:selectSyCode parentCode="AssetCategoryCode"
                        name="ASSET_CATEGORY_CODE" onChange="changeAss(this.value)"
                        selected="${assetDetail.ASSET_CATEGORY_CODE}" limit="all" /> <span
                    id="TipCategory"
                    style="color: black; font-size: 12px; cursor: pointer"
                    onclick="spf_createCategory()"><spring:message code="ass.noSuitableCategory"/>？</span>
                </td>
          
                <td width="10%" class="l-table-edit-t" style="display: none;"><spring:message code="ass.assetID"/><font color="red">*</font></td>
                <td width="width" class="l-table-edit-c" id="categorySelection" style="display: none;">
                    <input type="text" name="ASSET_ID" id="ASSET_ID" value="${assetDetail.ASSET_ID}" size="30" onchange="spf_checkAssetID();" />
                    <span id="TipID" style="color: green; font-size: 12px; width: 10px"></span>
                    <%-- <input type="radio" name="id_type" id="id_type1" value="1" onChange="spf_checkAssetID(this.value);" checked /> <spring:message code="hrms.intern" />
                    <input type="radio" name="id_type" id="id_type2" value="2" onChange="spf_checkAssetID(this.value);"  /> <spring:message code="hrms.extern" /> --%>
                    <input type="radio" name="id_type" id="id_type3" value="3" onChange="spf_checkAssetID(this.value);" checked="checked"/> <spring:message code="hrms.mix" /></td>
                <td width="10%" class="l-table-edit-t" nowrap="nowrap"><spring:message code="ass.assetName"/><font color="red">*</font></td>
                <td width="20%" class="l-table-edit-c" nowrap="nowrap"><input type="text" name="ASSET_NAME" id="ASSET_NAME"
        ...
        <table width="99.6%" align="center" cellpadding="0" cellspacing="0"
            ...
            <tr>
                <td width="10%" class="l-table-edit-t"><spring:message code="ass.engliseName"/></td>
