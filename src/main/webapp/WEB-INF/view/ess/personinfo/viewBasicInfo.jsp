...
<script type="text/javascript">
	...
	function spf_photo_ChildWindowClose() {
		$("#headImage").attr("src",
				"/resources/picture/employee/${basicInfo.EMPID }.jpg?" + Math.random());
		$dialog.close();
	}
</script>
<style type="text/css">
			...
			<table width="99.5%" align="center" cellpadding="0" cellspacing="0"
				...
				<tr height="30px;">
					...
					<td  class="l-table-edit-c" nowrap="nowrap">
						${basicInfo.EMPID } <input type="hidden" name="EMPID" id="EMPID"
						value="${basicInfo.EMPID }" onclick="searchEmp();" />
					</td >
					<td  class="l-table-edit-t" nowrap="nowrap"><spring:message
							code="hrms.name" /></td>
					<td  class="l-table-edit-c" nowrap="nowrap">
