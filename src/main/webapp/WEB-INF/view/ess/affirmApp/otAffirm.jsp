...
<script type="text/javascript"> 
    ...
    function f_initGrid()
    {
    	$grid = $("#empInfo").ligerGrid({
    		checkbox: true,
    		columns: [   
			            { display: '', name: 'OT_NO', width: 10,hide: 1},
			            ...
			            { display: '<spring:message code="hrms.otType"/>', name: 'OT_TYPE_NAME', width: 120},  
			            { display: '<spring:message code="hrms.otDate"/>', name: 'OT_DATE', width: 90},  
			            { display: '<spring:message code="hrms.startedTime"/>', name: 'OT_FROM_TIME', width: 110},  
			            { display: '<spring:message code="hrms.endTime"/>', name: 'OT_TO_TIME', width: 110}, 
			            { display: '<spring:message code="hrms.workingDescription"/>', name: 'OT_CONTENT', align: 'left', width: 120,
            ...
            url: '/ess/affirmApp/getAffirmOtInfo',
            parms: [	
    ...
    function spf_showDetailData(otNo,flag)
    {    
    	$dialog = $.ligerDialog.open({isDrag: false, 
    		title:'<spring:message code="hrms.approvalActive"/>', 
    		width: 700, 
    		height: 320, 
  		    url: '/ess/viewApp/viewApproverInfo?PAGE=A&FLAG='+flag+'&APPLY_TYPE=OtApply&APPLY_NO='+otNo
       	  });
    }
    function spf_search()
    {
    	$grid.setOptions({ parms: [	
		                        	...
		                        	{ name: 'OT_TYPE_CODE', value: $("#OT_TYPE_CODE").attr('value')}, 
		                        	{ name: 'qryType', value: $("#qryType").attr('value')}
    	                           ],
    	                   newPage: 1
    	                 }); //设置数据参数
		...
		<div position="center" id='' title=' '>
			<div position="top">
				<table width="99.6%" cellpadding="0" cellspacing="0"
					...
					<tr>
						<td class="l-table-edit-t"><spring:message code="hrms.otDate" /></td>
