    ...
    function f_initGrid(){
    	$grid = $("#empInfo").ligerGrid({
    		...
    		columns: [
			            ...
			            { display: '<spring:message code="hrms.name"/>', name: 'CHINESENAME', width: 70},
			            { display: '<spring:message code="hrms.empTypeName"/>', name: 'EMP_TYPE_NAME', width: 70},
			            { display: '<spring:message code="hrms.dept"/>', name: 'DEPTNAME', width: 70},
			            { display: '<spring:message code="hrms.ApplyDate"/>', name: 'CREATE_DATE', width: 90},
			            { display: '<spring:message code="hrms.btType"/>', name: 'BT_TYPE_NAME', width: 70},
			            ...
			            { display: '<spring:message code="hrms.btCity"/>', name: 'DESTINATION', width: 90},
			            { display: '<spring:message code="hrms.workingContent"/>', name: 'BT_CONTENT', align: 'left', width: 220,
			            	editor: { type: 'textarea', height: 100 }
			            },
			            { display: '<spring:message code="hrms.approvalActive"/>', name: 'APP_STATUS', width: 60}
		            ],
			...
			<div position="top">
				<table width="99.6%" cellpadding="0" cellspacing="0"
					...
					<tr>
						...
						<td class="l-table-edit-t"><spring:message code="hrms.btType" /></td>
						<td class="l-table-edit-c" colspan="3"><SipingSoft:selectSyCode
								parentCode="BTTypeCode" name="BT_TYPE_CODE"
								onChange="spf_search();" limit="all" /></td>
						<td class="l-table-edit-t"><spring:message code="hrms.btDate" /></td>
