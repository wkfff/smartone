    ...
    function f_initGrid()
    {
    	$grid = $("#empInfo").ligerGrid({
    		...
    		columns: [
			            ...
			            { display: '<spring:message code="hrms.otType"/>', name: 'OT_TYPE_NAME', width: 90},
			            ...
			            { display: '<spring:message code="hrms.workingDescription"/>', name: 'OT_CONTENT', align: 'left', width: 200,
		...
		<div position="center" id='' title=' '>
			<div position="top">
				<table width="99.6%" cellpadding="0" cellspacing="0"
					...
					<tr>
						<td class="l-table-edit-t" nowrap="nowrap"><spring:message code="hrms.otType" /></td>
						<td class="l-table-edit-c" nowrap="nowrap" colspan="3"><SipingSoft:selectSyCode parentCode="OTTypeCode" 
							name="OT_TYPE_CODE" onChange="spf_search();" limit="all" /></td>
