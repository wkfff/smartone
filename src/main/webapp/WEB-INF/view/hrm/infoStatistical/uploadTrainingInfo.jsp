...
<script type="text/javascript">
                ...
                success : function(result) {
                    ...
                    if (result == "Y") { //弹出预览框
                        ...
                        $.ligerMessageBox.error(
                                '<spring:message code="hrms.warning"/>',
                                '<spring:message code="hrms.failedToUploadReason"/>' + '</br>（1）<spring:message code="hrms.pleaseRequiredComplete"/></br>（2）<spring:message code="hrms.pleaseCheckTheNumberIsCorrect"/></br>（3）<spring:message code="hrms.pleaseFillInTheCorrectDateFormat"/></br>（<spring:message code="hrms.forExample"/>2013-08-08）');
                    }
                }
            };
    ...
    function spf_checkData() {
        ...
        if (fileType != "XLS") {
            $.ligerMessageBox.warn('<spring:message code="hrms.warning"/>',
                    '<spring:message code="hrms.documentTypeMustBe"/>.xls');
            return false;
        }
        return true;
    }
                    ...
                    <td valign="middle">
                        <table width="99.6%" cellpadding="1" cellspacing="1"
                            ...
                            <tr>
                                ...
                                <td height="30px;" align="left"><input type="file" value="<spring:message code='hrms.browse' />"
