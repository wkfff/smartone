   ...
   <meta http-equiv="X-UA-Compatible" content="IE=edge" >
    ...
    function f_initGrid(){
        $grid = $("#empInfo").ligerGrid({
            checkbox: true,
            columns: [
                        { display: '', name: 'REWARD_NO', width: 10,hide:1},
                        ...
                        { display: '<spring:message code="hrms.rewardReason"/>', name: 'REWARD_REASON', align: 'left', width: 160,
                            editor: { type: 'textarea', height: 100 }
                        },
                        { display: '<spring:message code="hrms.rewardAmount"/>', name: 'REWARD_AMOUNT', width: 90}, 
                        { display: '<spring:message code="hrms.rewardDate"/>', name: 'REWARD_DATE', width: 120},
            ...
            url: '/hrm/searchTransferOrder/getRewardInfoList',
            parms: [
    ...
    function spf_search(){
        $grid.setOptions({ parms: [
                                    ...
                                    { name: 'REWARD_TYPE_CODE', value: $("#REWARD_TYPE_CODE").attr('value')},
       ...
       $(rows).each(function (index, row){
           if(this.CANCEL_REMARK == null || this.CANCEL_REMARK == 'undefined' ){
                    $.ligerMessageBox.warn('<spring:message code="hrms.warning"/>', '<spring:message code="hrms.cancelRemarks"/>'  +". " + '<spring:message code="input.required"/>') ; 
                     ...
                     jsonData += '"REWARD_NO": "'+this.REWARD_NO+'",';
                     jsonData += '"CANCEL_REMARK":"'+this.CANCEL_REMARK+'",';
                     jsonData += '"rollbackTyep":"Reward"';
                     jsonData += '}';
                 }
        });
        jsonData += ']';
...
//          $.ligerMessageBox.error('<spring:message code="hrms.warning"/>', '<spring:message code="hrms.editData"/>') ;
                ...
                $.ligerDialog.waitting('<spring:message code="hrms.canceling"/>');
                   $.post("/hrm/searchTransferOrder/cancelDoc2",
                           [
                                ...
                                { name: 'rollbackType', value: 'Reward'}
                           ],
                   function (result){
    ...
    function spf_insExcel(colums){
        ...
        location.href='/hrm/transferOrder/getRewardInfoByExcel?PA_MONTH=' + attMonth+'&S_DATE='
     ...
     <div position="top">  
            <table width="99.6%" cellpadding="0" cellspacing="0" class="l-table-edit_01" border="1xp" bordercolor="#A3C0E8">
               <tr>
                 ...
                 <tr> 
                   <td class="l-table-edit-t"><spring:message code="hrms.awardType"/></td>
