   ...
   <meta http-equiv="X-UA-Compatible" content="IE=edge" >
    ...
    function f_initGrid()
    {
        $grid = $("#empInfo").ligerGrid({
            checkbox: true,
            columns: [  
                        { display: '', name: 'ACT_BIZ_NO', width: 10,hide:1},
                        ...
                        { display: '<spring:message code="hrms.workingDescription"/>', name: 'BIZ_NAME', width: 130},   
            ...
            url: '/hrm/searchTransferOrder/getActBusinessInfoList',
            parms: [    
                    { name: 'ACTIVITY',value: $("#ACTIVITY").attr('value')},
                    { name: 'TRANS_CODE',value: 'TransCode_140'}
                   ],
    ...
    {   
             ...
             {   
               if(this.CANCEL_REMARK == null || this.CANCEL_REMARK == 'undefined' ){ 
                    $.ligerMessageBox.warn('<spring:message code="hrms.warning"/>', '<spring:message code="hrms.cancelRemarks"/>'  +". " + '<spring:message code="input.required"/>') ; 
                     ...
                     jsonData += ' "ACT_BIZ_NO": "' + this.ACT_BIZ_NO + '", ' ; 
                     jsonData += ' "CANCEL_REMARK": "' + this.CANCEL_REMARK + '", ' ; 
                     jsonData += ' "rollbackTyep": "ActBusiness"' ;
                     jsonData += '}' ;
                 }
       ...
       $.post("/hrm/searchTransferOrder/cancelDoc", 
               [    
                    ...
                    { name: 'rollbackTyep', value: 'ActBusiness' }
               ]
       , function (result)
       {
