        ...
        <div position="center" id='' title=' '>
            <div position="top">
                    ...
                    <table width="99.5%" align="center" cellpadding="0" cellspacing="0"
                        ...
                        <tr>
                            ...
                            <td width="35%" class="l-table-edit-c" nowrap="nowrap">
                                <input type="text" name="EMPID" id="EMPID_NAME" value="${basicInfo.CHINESENAME }"  />
                                <input type="hidden" name="EMPID" id="EMPID" value="${basicInfo.EMPID }"  />
                            </td>
                            <td width="15%" class="l-table-edit-t"><spring:message code="hrms.applicant" /></td>
                            <td width="35%" class="l-table-edit-c">${basicInfo.CHINESENAME}</td>
                        </tr>
                        <tr>
                            ...
                            <td class="l-table-edit-c"><input type="text"
                                name="BT_FROM_TIME" id="BT_FROM_TIME" value="${currentDate}"
                            ...
                            <td class="l-table-edit-c"><input type="text"
                                name="BT_TO_TIME" id="BT_TO_TIME" value="${currentDate}"
                                onclick="WdatePicker({lang:<spring:message code='dateLanguage'/>,isShowClear:false,readOnly:true,dateFmt:'yyyy-MM-dd HH:mm'})" />
                            </td>
                        </tr>
                        <tr>
                            ...
                            <td class="l-table-edit-t"><spring:message
                                    code="hrms.btType" /><font color="red">*</font></td>
                ...
                <table width="99.5%" align="center" cellpadding="0" cellspacing="0"
                    ...
                    <tr>
                        <td width="15%" class="l-table-edit-t"><spring:message
                                code="hrms.btCity" /><font color="red">*</font></td>
