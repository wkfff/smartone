...
function spf_save(){
    if(spf_checkData()){	    
        ...
        $.post("/hrm/empinfo/addLanuageInfo", 
                [	   
...
{    
    ...
    if (LANGUAGE_TYPE_CODE == null || LANGUAGE_TYPE_CODE == "") { 
       	 $.ligerMessageBox.warn('<spring:message code="hrms.warning"/>', '<spring:message code="hrms.languageType"/>'+". " + '<spring:message code="input.required"/>') ; 
       	 return false; 
    }   
		            ...
		            <tr>
		                <td align="center" valign="middle"> 
					        <table width="99.6%" cellpadding="0" cellspacing="0" class="l-table-edit_01" border="1xp" bordercolor="#A3C0E8">
					            <tr>
					                <td width="160px;" class="l-table-edit-t"><spring:message code="hrms.languageType"/></td>
					                <td width="60px;" class="l-table-edit-c" colspan="2">  
					                	<input type="hidden" name="EMPID" id="EMPID" value="${paramMap.EMPID }"/>
					                	<SipingSoft:selectSyCode parentCode="LanguageTypeCode" name="LANGUAGE_TYPE_CODE"/> 
					                </td>  
					             </tr>
					             <tr>
					             ...
					             <tr>
					                ...
					                <td width="60px;" class="l-table-edit-c" colspan="2">   
					                	<input type="text" name="LAN_INSTITUTE" id="LAN_INSTITUTE" value="" validate="{required:true}"/> 
					                </td>  
					             </tr>
					             <tr>
					                <td width="160px;" class="l-table-edit-t"><spring:message code="hrms.grade"/></td>
					                <td width="60px;" class="l-table-edit-c" colspan="2">   
					                	<SipingSoft:selectSyCode parentCode="LanguageLevelCode" name="LANGUAGE_LEVEL_CODE"/> 
					                </td>  
					             </tr>
					             <tr>
					                <td width="160px;" class="l-table-edit-t"><spring:message code="hrms.fraction"/></td>
					                <td width="60px;" class="l-table-edit-c" colspan="2">   
					                	<input type="text" name="MARK" id="MARK" value="" ltype='spinner' ligerui="{type:'float'}"/> 
					                </td>  
					             </tr>
					            <tr>
