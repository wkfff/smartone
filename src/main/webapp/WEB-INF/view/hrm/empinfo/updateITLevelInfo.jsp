...
function spf_save(){
    if(spf_checkData()){	    
        ...
        $.post("/hrm/empinfo/updateITLevelInfo", 
                [	    
					        ...
					        <table width="99.6%" cellpadding="0" cellspacing="0" class="l-table-edit_01" border="1xp" bordercolor="#A3C0E8">
					             <tr>
					                ...
					                <td width="60px;" class="l-table-edit-c" colspan="2">  
					                	<input type="hidden" name="EMPID" id="EMPID" value="${itInfo.EMPID }"/>
					                	<input type="hidden" name="NO" id="NO" value="${itInfo.NO }"/>
					                	<SipingSoft:selectSyCode parentCode="LanguageExamCode" name="EXAM_TYPE_CODE" selected="${itInfo.EXAM_TYPE_CODE }"/> 
					                </td>  
					             </tr>
					             <tr>
					                <td width="160px;" class="l-table-edit-t"><spring:message code="hrms.grade"/></td>
					                <td width="60px;" class="l-table-edit-c" colspan="2">   
					                	<SipingSoft:selectSyCode parentCode="LanguageLevelCode" name="IT_LEVEL_CODE" selected="${itInfo.IT_LEVEL_CODE }"/> 
					                </td>  
					             </tr>
					             <tr>
					                <td width="160px;" class="l-table-edit-t"><spring:message code="hrms.certificateName"/></td>
					                <td width="60px;" class="l-table-edit-c" colspan="2">   
					                	<input type="text" name="IT_INSTITUTE" id="IT_INSTITUTE" value="${itInfo.IT_INSTITUTE }" validate="{required:true}"/> 
					                </td>  
					             </tr>
					            <tr>
					             ...
					             <tr>   
					                ...
					                <td class="l-table-edit-c" colspan="2">
							       	   	<textarea rows="3" cols="" style="width: 300px" 
							       	   			id="DESCRIPTION" name="DESCRIPTION" >${itInfo.DESCRIPTION }</textarea>  
					                </td>
					            </tr>  
					             <tr>   
					                ...
					                <td class="l-table-edit-c" colspan="2">  
							       	   	<textarea rows="3" cols="" style="width: 300px" 
							       	   			id="REMARK" name="REMARK" >${itInfo.REMARK }</textarea> 
					                </td>
					            </tr>   
					        </table> 
		       			</td>
