   ...
   <meta http-equiv="X-UA-Compatible" content="IE=edge" >
    ...
    { 
    	$grid_i = $("#inputItemInfo").ligerGrid({
    		...
    		columns: [   
			            ...
			            { display: '<spring:message code="hrms.attItemName"/>', name: 'ITEM_NAME', align: 'left',width: 120}  
    ...
    { 
    	$grid_f = $("#empInfo").ligerGrid({
    		...
    		columns: [   
			            ...
			            { display: '', name: 'ITEM_NO', width: 10,hide: 1}, 
			            { display: '<spring:message code="condition"/>', name: 'CONDITION', align: 'left', width: 320,
            ...
            enabledEdit: true,usePager: false, rownumbers:true,
            url: '/att/attendanceSettings/getAttMFormulaCnInfo?ITEM_NO='+itemNo,
            width: '99.6%', height: '99%'
        });
    }
        ...
        if (!itemNo || itemNo == "") { 
      	...
      	$dialog = $.ligerWindow.show({isDrag: true,
   		    title:'<spring:message code="hrms.add"/>'+' '+'<spring:message code="hrms.detail"/>', 
        	 	...
        	 	height: 500 , 
        	 	left:120,top:60,
	    		url: '/att/attendanceSettings/addAttMFormulaInfo?ITEM_NO='+itemNo
        	}); 
    } 
    ...
    {   
    	var paMonth = $("#year").attr('value') + $("#month").attr('value');
      	...
      	if(lockFlag == '0'){
	       ...
	       $.post("/att/attendanceSettings/deleteAttMFormulaInfo", 
	               [	 
	                	{ name: 'FORMULAR_NO', value: row.FORMULAR_NO }
	               ]
	       , function (result)
	       {
    ...
    {  
    	...
    	$dialog = $.ligerDialog.open({isDrag: false, showMax: true,showMin: true,
    		...
    		url: '/att/attendanceSettings/upadteAttMFormulaInfo?FORMULAR_NO=' + rows.FORMULAR_NO + '&ITEM_NO=' + rows.ITEM_NO
       	  });
    }
	</script>
...
<body style="padding:2px" > 
	 <div position="top" >   
 	 ...
 	 <div id="layout1" >     
	       <div position="left" id="inputItemInfo" class="l-scroll" title='<spring:message code="hrms.calculationItem"/>'></div>
	       <div position="center" id='empInfo' title='<spring:message code="hrms.detail"/>' ></div>  
    </div> 
</body>
</html>
