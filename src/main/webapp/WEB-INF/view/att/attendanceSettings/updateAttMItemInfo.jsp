...
<script type="text/javascript">
   ...
   function f_save() { 
       ...
       $.ligerDialog.waitting('<spring:message code="hrms.saveing"/>');
        ...
        var options = {	                        
            url:'/att/attendanceSettings/updateAttMItemInfo',
            type:'POST',	                        
		     ...
		     <form name="form1" method="post" action="" id="form1">
		            ...
		            <%-- <tr>
		                ...
		                <td class="l-table-edit-c"> 
		                	<input type="text" name="ITEM_ID" id="ITEM_ID" value="${attMItemInfo.ITEM_ID}" 
		             ...
		             <tr>   
		                ...
		                <td class="l-table-edit-c">
		                    <input type="hidden" name="ITEM_NO" value="${attMItemInfo.ITEM_NO}" />
		                    <input type="hidden" name="ITEM_ID" value="${attMItemInfo.ITEM_ID}" />
		                	<input type="text" name="ITEM_NAME" id="ITEM_NAME" value="${attMItemInfo.ITEM_NAME}" 
		            ...
		            <tr>   
		                ...
		                <td class="l-table-edit-c">
		                	<input type="text" name="ITEM_EN_NAME" id="ITEM_EN_NAME" value="${attMItemInfo.ITEM_EN_NAME }" 
		                	ltype="text"  validate="{required:true}" onkeyup="value=value.replace(/[^\w\.\/]/ig,'')"/>
		                </td>
		            </tr>  
		             <tr>   
		                ...
		                <td class="l-table-edit-c">
		                	<SipingSoft:selectSyCode parentCode="ItemUnit" name="UNIT" selected="${attMItemInfo.UNIT_CODE }"/>
		                </td> 
		            </tr>    
		            <tr>   
		                <td class="l-table-edit-t"><spring:message code="hrms.minimumUnit"/></td>
		                <td class="l-table-edit-c"> 
					    	<input name="MIN_UNIT" type="text" id="MIN_UNIT" value="${attMItemInfo.MIN_UNIT }" 
		             ...
		             <tr>   
		                ...
		                <td class="l-table-edit-c"> 
							<SipingSoft:selectStatus name="ACTIVITY" selected="${attMItemInfo.STATUS_ID }"/>
		                </td> 
		            </tr>    
		            <tr>   
		                <td class="l-table-edit-t"><spring:message code="hrms.company"/></td>
		                <td class="l-table-edit-c">
							<SipingSoft:selectCompany name="CPNY_ID" selected="${attMItemInfo.CPNY_ID }"/>
		                </td> 
		            </tr>   
		            <tr>
