...
<script type="text/javascript">
    ...
    function spf_save(){
	    if(spf_checkData()){	    
		      ...
		      var options = {	                        
		          url:'/att/attendanceSettings/updateAttMFormulaInfo',
		          type:'POST',	                        
    ...
    {    
      	$dialog = $.ligerWindow.show({isDrag: true,
  		    title: '<spring:message code="tool"/>',
        	 	...
        	 	height: 400 , 
        	 	left:180,top:60,
    		    url: '/att/attendanceSettings/ViewAttMFormulaTool'
        	}); 
    } 
</script>
		        ...
		        <table width="99%" cellpadding="1" cellspacing="1" style="height:25px;font-size: 12px;">
		           ...
		           <tr>
		           	   ...
		           	   <td width="84%" class="l-table-edit-c">
			       	   		<textarea rows="8" cols="100" id="CONDITION" name="CONDITION">${attMFormulaInfo.CONDITION }</textarea>
			       	   </td>
		           </tr> 
		           <tr>
			       	   <td width="15%" class="l-table-edit-t"><spring:message code="formula"/></td>
		           	   <td width="84%" class="l-table-edit-c">
			       	   		<textarea rows="8" cols="100" id="FORMULAR" name="FORMULAR" onkeyup="spf_fd();">${attMFormulaInfo.FORMULAR }</textarea>
			       	   </td>
		           </tr>  
		           <tr>
			       	   <td width="15%" class="l-table-edit-t"><spring:message code="hrms.description"/></td>
		           	   <td width="84%" class="l-table-edit-c">
			       	   		<textarea rows="3" cols="100" id="DESCRIPTION" name="DESCRIPTION">${attMFormulaInfo.DESCRIPTION }</textarea>
			       	   		<input type="hidden" id="FORMULAR_NO" name="FORMULAR_NO" value="${attMFormulaInfo.FORMULAR_NO }"> 
			       	   </td>
		           </tr>    
		       </table>
	         </form>
