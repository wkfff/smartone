...
<script type="text/javascript">
    ...
    function f_save(){ 
          ...
          var options = {	                        
              url:'/system/rightsSupplierManagement/updateLoginSupplierInfo',
              type:'POST',	                        
		...
		<div style="border: 1px solid #A3C0E8;">
			<div align="left" >
				<form name="form1" method="post" action="" id="form1">
					<input type="hidden" name="SUPPLIER_ID" value="${loginSupplierInfo.SUPPLIER_ID}"/>
					<table width="99.6%" cellpadding="0" cellspacing="0"
						...
						<tr>
							<td class="l-table-edit-t"><spring:message
									code="username" /></td> 
							<td class="l-table-edit-c">${loginSupplierInfo.SUPPLIER_ID}</td>
								<input id="ADMINNO" name="ADMINNO" type="hidden" value="${loginSupplierInfo.ADMINNO}"/>
							<td class="l-table-edit-t"><spring:message
									code="hrms.active" /></td>
							<td class="l-table-edit-c"><SipingSoft:selectStatus
									name="ACTIVITY" selected="${loginSupplierInfo.STATUS_ID}" /></td>
							<td class="l-table-edit-t"><spring:message
									code="hrms.company" /></td>
							<td class="l-table-edit-c">${loginSupplierInfo.SUPPLIER_NAME}</td>
						</tr>
						<tr>
							<td class="l-table-edit-t"><spring:message code="hrms.role" /></td>
							<td class="l-table-edit-c" colspan="5" height="80" id='checkBoxTd'>
								<c:forEach
									items="${loginSupplierInfoRolesGroupList}" var="rolesGroup">
