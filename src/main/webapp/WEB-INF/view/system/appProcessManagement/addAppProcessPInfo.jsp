...
<script type="text/javascript">
    ...
    $(function() { 
    	...
    	$grid1 = $("#empInfo1").ligerGrid({
            ...
            usePager: false, dataAction: 'server', root: 'appProcessPAList',
            url: '/system/appProcessManagement/getAppProcessPAInfo?EMPID='+$("#EMPID").val(),
            width: '99%', height: '99%',allowUnSelectRow:true,
            onSelectRow: function (data, rowindex, rowobj)
            { 
                spf_delete($("#EMPID").val(),data.AFFIRM_TYPE_ID)
            }
        }); 
    }); 
    /*
    ...
    */
    ...
    function f_save() {
        ...
        $(rows).each(function ()
                {
		        	if (jsonData.length > 1){
                     ...
                     jsonData += ' "AFFIRM_OBJECT": "' + $("#EMPID").val() + '", ' ;
        ...
        var options = {	                        
                url:'/system/appProcessManagement/addAppProcessPInfo',
                type:'POST',	                        
