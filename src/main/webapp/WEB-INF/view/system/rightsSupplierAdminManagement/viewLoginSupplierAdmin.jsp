...
<script type="text/javascript">
    ...
    function f_initGrid()
    {
		$grid = $("#loginSupplierInfo").ligerGrid({
			...
			columns: [
						...
						{ display: '公司名称', name: 'SUPPLIER_NAME', align: 'center',width:'20%'},
		            ...
		            usePager: true, 
		            rownumbers: true,
		            root: 'loginSupplierAdminInfo',
		            record: 'loginSupplierInfoAdminCnt',
		            pageSize:20,
		            url: '/system/rightsSupplierAdminManagement/getLoginSupplierAdminInfo',
    ...
    { 
    	...
    	$dialog = $.ligerDialog.open({isDrag: false, title:'<spring:message code="hrms.update"/>', 
    		...
    		top:"20%",
    		url: '/system/rightsSupplierAdminManagement/updateLoginSupplierAdminView?ACTIVITY=1&CPNY_ID=' + rows.CPNY_ID +'&ADMINID='+ rows.ADMINID
        });
    }
