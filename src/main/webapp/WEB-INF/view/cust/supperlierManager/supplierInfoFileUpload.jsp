...
<script type="text/javascript">
    ...
    function f_save() {
        if (spf_checkData()) {
            ...
            var options = {
                url : '/cust/supperlierManager/uploadSupplierInfoTemplate',
                type : 'POST',
                            ...
                            <table width="99.6%" cellpadding="1" cellspacing="1" style="height: 30px; font-size: 12px;">
                                ...
                                <tr>
                                    ...
                                    <td height="30px;"><a class="l-button"
                                        style="width: 79px; height: 20px; float: left; margin-left: 1px;" onclick="f_save()"><spring:message code="hrms.save" /></a></td>
                                </tr>
                                <tr>
                                    <td height="30px;" align="left">&nbsp;</td>
                                    <td height="30px;">
