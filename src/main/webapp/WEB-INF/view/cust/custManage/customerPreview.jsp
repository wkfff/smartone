...
<script type="text/javascript">
    ...
    function f_initGrid(colums) {
        $grid = $("#contractInfo").ligerGrid({
            ...
            usePager : true,
            rownumbers : true,
            url : '/cust/custManage/getCustTmpInfoList',
            width : '99.6%',
            height : '95%',
            pageSize:100,
            pageSizeOptions:[100],
    ...
    function checkNull(row){
        if(row.CUST_ID==null||row.CUST_NAME==null||row.CUST_SALES_MODE_CODE==null
                ||row.CUST_TYPE_CODE==null||row.CONTACTS_MOBILE1==null||row.CONTACTS_NAME==null){
            return true;
        }
        return false;
    }
    ...
    function spf_saveCustTmpInfo() {
        ...
        if(checkNotNull()){
            ...
            var options = {
                url : '/cust/custManage/saveCustTmpInfo',
                type : 'POST',
    ...
    <div id="layout1">
        ...
        <table width="99.5%" align="center" cellpadding="0" cellspacing="0" class="l-table-edit" border="0xp" bordercolor="#A3C0E8">
            ...
            <tr>
                <td>
                    <div align="center">
                        <a class="l-button" style="width: 79px; height: 20px; " onclick="spf_saveCustTmpInfo()"><spring:message
