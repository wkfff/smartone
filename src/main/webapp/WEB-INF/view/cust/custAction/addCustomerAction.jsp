...
//初始化数据 
 ...
 /*    function spf_setTime()
    ...
    function init_css()
    {
        $("[name='CREATED_DATE'],[name='CUST_ACTION_TIME'],[name='TRACE_STATUS_CODE'],[name='CUST_ACTION_WAY_CODE'],[name='PURCHASE_TEND_CODE'],[name='CONTACT'],[name='ACTION_TYPE_CODE']").css({
...
/*  *************************************************** */
    ...
    function spf_save() {
        ...
        if(spf_checkData()){
             ...
             $.post("/cust/custAction/addCustomerAction", 
                     [  
                        { name: 'type', value: 'add'},
                        { name: 'CUST_ID', value: $("#CUST_ID").val()},
                        { name: 'EMP_ID', value: $("#EMP_ID").val()},
                        { name: 'ACTION_TYPE_CODE', value: $("#ACTION_TYPE_CODE").val()},
                        { name: 'CUST_NAME', value: $("#CUST_NAME").val()}, 
                        { name: 'REMINDER', value: $("#REMINDER").val()},
                        { name: 'CUST_ACTION_TIME', value: $("#CUST_ACTION_TIME").val()},
                        { name: 'WAY_CODE_NEXT', value: $("#WAY_CODE_NEXT").val()},
                        { name: 'TIME_NEXT', value: $("#TIME_NEXT").val()},
                        { name: 'CUST_ACTION_CONTENT', value: $("#CUST_ACTION_CONTENT").val()},
                        { name: 'CONTACT', value: $("#CONTACT").val()},
                        { name: 'PURCHASE_TEND_CODE', value: $("#PURCHASE_TEND_CODE").val()},
                        { name: 'TRACE_STATUS_CODE', value: $("#TRACE_STATUS_CODE").val()},
                        { name: 'CUST_ACTION_WAY_CODE', value: $("#CUST_ACTION_WAY_CODE").val()}, 
    ...
    function spf_checkData()  //Reserved
    {
        ...
        if ($("#PURCHASE_TEND_CODE").val() == null || $("#PURCHASE_TEND_CODE").val() == "") {  
            $.ligerMessageBox.warn('<spring:message code="hrms.warning"/>', '购买等级'+". " + '<spring:message code="input.required"/>') ; 
            return false; 
      }
...
<div id="layout1" style="width:99.6%;margin:0; padding:0;">  
    ...
    <input type="hidden" name="CUST_ID" id="CUST_ID"/> 
        ...
        <table width="99.6%" cellpadding="1" cellspacing="1" style="font-size: 12px;">
          ...
          <tr> 
               <td width="10%" class="l-table-edit-t"><spring:message code="hrms.createDate"/><font color="red">*</font></td>
          ...
          <td width="10%" class="l-table-edit-t"><spring:message code="hrms.customer"/><font color="red">*</font></td>
             ...
             <td width="10%" class="l-table-edit-t"><spring:message code="hrms.activityTime"/><font color="red">*</font></td>
               <td width="20%" class="l-table-edit-c">    
                    ...
                    id="CUST_ACTION_TIME" value="${DDATE}"  size="30"
