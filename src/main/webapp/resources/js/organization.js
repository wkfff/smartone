...
/*
 * @Generator -> Surnfu - P_EMAIL:Surnfu@126.com - QQ:31333716 Ver:1.0.0
 * @Copyright (c) 2009 Surnfu composition http://www.on-cn.com 使用示例
 * ==============================================================================
 * var a=new OrgNode() a.Text="节点文本" a.Description="节点描述" a.Link="节点链接"
 * //a.customParam.Img="xxx" //自定义节点参数，需要设置节点模板 var b=new OrgNode()
 * b.Text="节点文本" b.Description="节点描述" b.Link="节点链接" a.Nodes.Add(b); var
 * OrgShows=new OrgShow(a); OrgShows.Top=50; //设置顶距离 OrgShows.Left=50; //设置左距离
 * OrgShows.IntervalWidth=10; //设置节点间隔宽度 OrgShows.IntervalHeight=20; //设置节点间隔高度
 * OrgShows.ShowType=2; //设置节点展示方式 1横向 2竖向 OrgShows.BoxHeight=100; //设置节点默认高度
 * //OrgShows.BoxWidth=100; //设置节点默认宽度 //OrgShows.BoxTemplet="="<div
 * id=\"{Id}\" style=\"font-size:12px;padding:5px 5px 5px 5px;border:thin solid
 * orange;background-color:lightgrey;
 * clear:left;float:left;text-align:center;position:absolute;\"
 * title=\"{Description}\" ><a href=\"{Link}\">{Text}</a></div>";自定义节点模板
 * OrgShows.LineSize=2; //设置线条大小 OrgShows.LineColor=2; //设置线条颜色 OrgShows.Run()
 * ==============================================================================
 */
function OrgNode() {
    this.Text = null;
