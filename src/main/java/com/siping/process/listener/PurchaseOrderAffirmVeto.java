...
@Component
public class PurchaseOrderAffirmVeto implements ExecutionListener {

    Logger logger = Logger.getLogger(PurchaseOrderAffirmVeto.class);
    @Autowired
    ...
    public void notify(DelegateExecution delegateExecution) throws Exception {
        ...
        try {
            affirmSer.updatePurchaseOrderStatusVeto(processName, processInstanceId);
        } catch (Exception e) {
            e.printStackTrace();
        }
