...
@Component
public class HrApplicationAffirmAgree implements ExecutionListener {

    Logger logger = Logger.getLogger(HrApplicationAffirmAgree.class);
    ...
    public void notify(DelegateExecution delegateExecution) {
        ...
        try {
            affirmSer.updateHrApplicationAgree(processName, processInstanceId);
        } catch (Exception e) {
            e.printStackTrace();
        }
