...
@Component
public class UpdateBusinessDataResultSuccess extends UpdateProcessRunning implements ExecutionListener, TaskListener {
    ...
    public void notify(DelegateExecution delegateExecution) {
        ...
        try {
            updateResult(busiData, ResultEnum.SUCESS);
        } catch (Exception e) {
