...
@Component
public class SalesOrderAffirmAgree implements ExecutionListener {

    Logger logger = Logger.getLogger(SalesOrderAffirmAgree.class);
    ...
    public void notify(DelegateExecution delegateExecution) {
        ...
        try {
            affirmSer.updateSalesOrderStatusAgree(processName, processInstanceId);
        } catch (Exception e) {
            e.printStackTrace();
        }
