...
@Component
public class SalesOrderAffirmVeto implements ExecutionListener {

    Logger logger = Logger.getLogger(SalesOrderAffirmVeto.class);
    ...
    public void notify(DelegateExecution delegateExecution) {
        ...
        try {
            affirmSer.updateSalesOrderStatusVeto(processName, processInstanceId);
        } catch (Exception e) {
            e.printStackTrace();
        }
