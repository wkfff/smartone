...
@Component
public class HrApplicationAffirmVeto implements ExecutionListener {

    Logger logger = Logger.getLogger(HrApplicationAffirmVeto.class);
    ...
    public void notify(DelegateExecution delegateExecution) {
        ...
        try {
            affirmSer.updateHrApplicationVeto(processName, processInstanceId);
        } catch (Exception e) {
            e.printStackTrace();
        }
